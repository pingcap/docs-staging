...
通过配置 DMCluster CR 来配置 DM 集群。参考 DMCluster [示例](<https://github.com/pingcap/tidb-operator/blob/v1.6.4/examples/dm/dm-cluster.yaml>)和 [API 文档](<https://github.com/pingcap/tidb-operator/blob/v1.6.4/docs/api-references/docs.md#dmcluster>)（示例和 API 文档请切换到当前使用的 TiDB Operator 版本）完成 DMCluster CR (Custom Resource)。
