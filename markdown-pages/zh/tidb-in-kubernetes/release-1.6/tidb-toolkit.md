...
pingcap/tidb-lightning  v1.6.6                          A Helm chart for TiDB Lightning
pingcap/tidb-operator   v1.6.6          v1.6.6          tidb-operator Helm chart for Kubernetes
```
...
wget http://charts.pingcap.com/tidb-lightning-v1.6.6.tgz
```
