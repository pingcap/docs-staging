...
关于 Thanos Receiver 部署，可参考 [kube-thanos](https://github.com/thanos-io/kube-thanos) 以及 [Example](<https://github.com/pingcap/tidb-operator/tree/v1.6.6/examples/monitor-prom-remotewrite>)。
...
关于 Thanos Query 部署, 参考 [kube-thanos](https://github.com/thanos-io/kube-thanos) 以及 [Example](<https://github.com/pingcap/tidb-operator/tree/v1.6.6/examples/monitor-with-thanos>)。
