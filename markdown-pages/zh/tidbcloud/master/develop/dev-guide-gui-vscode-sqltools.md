...
6. 在设置面板中，配置以下连接参数：
    ...
    ![VS Code SQLTools: configure connection settings for {}](https://docs-download.pingcap.com/media/images/docs/develop/vsc-sqltools-connection-config-serverless.jpg)
...
7. 点击 **TEST CONNECTION** 验证与 {} 集群的连接。
    ...
    2. 在 **SQLTools Driver Credentials** 对话框中，输入你在第 4 步创建的密码。
        ...
        ![VS Code SQLTools: enter password to connect to {}](https://docs-download.pingcap.com/media/images/docs/develop/vsc-sqltools-password.jpg)
