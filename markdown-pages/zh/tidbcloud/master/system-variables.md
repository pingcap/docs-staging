...
> **注意：**
>
> 对于 [TiDB Cloud Premium](https://docs.pingcap.com/tidbcloud/select-cluster-tier/#premium)，该变量为只读。
...
> **注意：**
>
> 对于 TiDB Cloud Premium，该变量为只读。如需修改，请联系 [TiDB Cloud Support](/tidb-cloud/tidb-cloud-support.md)。
...
> **注意：**
>
> 对于 TiDB Cloud Premium，修改该变量仅对 `MODIFY COLUMN` DDL 任务生效，不影响 `ADD INDEX` DDL 任务。
