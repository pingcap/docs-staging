...
- 管理 TiDB Cloud Essential 实例
  - [创建 TiDB Cloud Essential 实例](/tidb-cloud/create-tidb-cluster-serverless.md)
  - 连接到你的 TiDB Cloud Essential 实例
  ...
  - [删除 TiDB Cloud Essential 实例](/tidb-cloud/delete-tidb-cluster.md)
- 迁移或导入数据
...
- 同步数据 ![BETA](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/blank_transparent_placeholder.png)
...
- 通用参考
  ...
  - [适用于 TiDB Cloud Starter 和 Essential 的项目 API 迁移指南](/tidb-cloud/tidbx-starter-essential-project-api-migration-guide.md)
- 支持计划
