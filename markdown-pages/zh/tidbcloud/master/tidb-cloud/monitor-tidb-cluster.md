...
本文档介绍如何监控 <CustomContent plan="starter">TiDB Cloud Starter 实例</CustomContent><CustomContent plan="essential">TiDB Cloud Essential 实例</CustomContent><CustomContent plan="premium">TiDB Cloud Premium 实例</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated 集群</CustomContent>。
...
在 TiDB Cloud 中，你可以通过以下页面查看 <CustomContent plan="starter">TiDB Cloud Starter 实例</CustomContent><CustomContent plan="essential">TiDB Cloud Essential 实例</CustomContent><CustomContent plan="premium">TiDB Cloud Premium 实例</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated 集群</CustomContent> 的常用统计/指标（信息）：
