...
2. 点击目标 <CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent> 的名称，进入其概览页面，然后在左侧导航栏点击 **Data** > **Data Migration**。
...
3. 填写目标连接信息。
   ...
   - **Username**：输入 TiDB Cloud 目标 <CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent> 的用户名。
