...
> **Tip:**
>
> 如果你想了解如何通过公共连接接入 TiDB Cloud Starter 或 TiDB Cloud Essential 实例，请参见 [Connect to TiDB Cloud Starter or Essential via Public Endpoint](/tidb-cloud/connect-via-standard-connection-serverless.md)。
