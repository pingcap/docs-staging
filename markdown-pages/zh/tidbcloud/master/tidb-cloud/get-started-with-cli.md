...
summary: 了解如何通过 TiDB Cloud CLI 管理 TiDB Cloud Starter 和 Essential 实例。
---
...
- 创建、删除和列出你的 TiDB Cloud Starter 或 Essential 实例。
- 向你的 TiDB Cloud Starter 或 Essential 实例导入数据。
- 从你的 TiDB Cloud Starter 或 Essential 实例导出数据。
...
要创建一个 TiDB Cloud Starter 实例，请输入以下命令，然后根据 CLI 提示提供所需信息：
