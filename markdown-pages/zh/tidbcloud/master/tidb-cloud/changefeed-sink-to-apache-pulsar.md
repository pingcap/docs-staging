...
> - 对于 [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) 实例，变更订阅功能不可用。
> - 对于 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) 实例，变更订阅功能处于 Beta 阶段。更多信息，参见 [Changefeed (Beta)](/tidb-cloud/essential-changefeed-overview.md)。
