---
title: 通过 Alibaba Cloud Private Endpoint 连接到 TiDB Cloud Premium
summary: 了解如何通过 Alibaba Cloud 上的私有端点连接到你的 TiDB Cloud Premium 实例。
---

# 通过 Alibaba Cloud Private Endpoint 连接到 TiDB Cloud Premium

本文档介绍如何通过 Alibaba Cloud 上的私有端点连接到你的 TiDB Cloud Premium 实例。通过私有端点进行连接，无需使用公共互联网，即可在你的服务与 TiDB Cloud Premium 实例之间实现安全且私密的通信。

> **Tip:**
>
> 如需了解如何通过 AWS PrivateLink 连接到 TiDB Cloud Premium 实例，请参见 [通过 AWS PrivateLink 连接到 TiDB Cloud Premium](/tidb-cloud/premium/connect-to-premium-via-aws-private-endpoint.md)。
...
### 步骤 1. 选择一个 TiDB Cloud Premium 实例 {#step-1-choose-a-premium-instance}

1. 在 [**My TiDB**](https://tidbcloud.com/tidbs) 页面上，点击目标 TiDB Cloud Premium 实例的名称，进入其概览页面。
...
4. 填写端点详细信息：
    - **Region**：选择与你的 TiDB Cloud Premium 实例相同的 Region。
...
- 在 **Domain name of Endpoint Service** 部分，复制 **Default Domain Name**。你稍后将使用该值作为 *Domain Name*。
    ...
    ![AliCloud private endpoint Information](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/private-endpoint/alicloud-private-endpoint-info.png)
...
### 步骤 4. 连接到你的 TiDB Cloud Premium 实例 {#step-4-connect-to-your-premium-instance}
