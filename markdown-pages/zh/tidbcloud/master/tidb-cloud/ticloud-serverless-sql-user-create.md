...
在一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例中创建 SQL 用户：
...
以交互模式在一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例中创建 SQL 用户：

```shell
ticloud serverless sql-user create
```

以非交互模式在一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例中创建 SQL 用户：
