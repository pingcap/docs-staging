...
要订阅 TiDB Cloud Dedicated 集群的告警通知，请按以下步骤操作：
...
1. 在 [TiDB Cloud console](https://tidbcloud.com) 中，进入你所在组织的 [**My TiDB**](https://tidbcloud.com/tidbs) 页面，然后点击目标 TiDB Cloud Essential 实例的名称，进入其实例概览页面。
...
1. 在 [TiDB Cloud console](https://tidbcloud.com) 中，进入你所在组织的 [**My TiDB**](https://tidbcloud.com/tidbs) 页面，然后点击目标 TiDB Cloud Premium 实例的名称，进入其实例概览页面。
2. 在左侧导航栏中，点击 **Settings** > **Alert Subscription**。
3. 在 **Alert Subscription** 页面右上角，点击 **Add Subscriber**。
4. 在 **Subscriber Type** 下拉列表中选择 **Webhook**。
5. 在 **Name** 字段中输入名称，并在 **Webhook URL** 字段中输入你的 webhook URL。
