...
更多信息，参见 [TiDB Cloud Premium Built-in Metrics](/tidb-cloud/premium/built-in-monitoring-premium.md)。

</CustomContent>

## 内置告警

内置告警是指 TiDB Cloud 提供的告警机制，帮助你监控 TiDB Cloud Essential 实例和 TiDB Cloud Dedicated 集群。目前，TiDB Cloud 提供以下三类告警：
...
在 TiDB Cloud 控制台的 Alerts 页面，你可以查看 TiDB Cloud Essential 实例或 TiDB Cloud Dedicated 集群的告警、编辑告警规则，并订阅告警通知邮件。
...
- 对于 TiDB Cloud Starter、Essential 和 Premium 实例，TiDB Cloud 在实例级别记录历史事件。
