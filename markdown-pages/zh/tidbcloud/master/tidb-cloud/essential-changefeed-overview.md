...
TiDB Cloud changefeed 帮助你将数据从 TiDB Cloud 流式传输到其他数据服务。目前，TiDB Cloud Essential 支持将数据流式传输到 Apache Kafka 和 MySQL。

> **注意：**
>
> - 目前，TiDB Cloud Essential 的 changefeed 功能仅可按需申请。要申请此功能，请执行以下操作：
>
...
>     4. 点击 **Submit**。
>
> - TiDB Cloud 每个 TiDB Cloud Essential 实例最多只允许创建 10 个 changefeed。
...
2. 点击目标 TiDB Cloud Essential 实例名称进入其概览页面，然后在左侧导航栏点击 **Data** > **Changefeed**。此时会显示 changefeed 页面。
...
1. 进入目标 TiDB Cloud Essential 实例的 [**Changefeed**](#view-the-changefeed-page) 页面。
...
对于 2026 年 7 月 1 日之前创建的现有 TiDB Cloud Essential 实例，changefeed 免费。

从 2026 年 7 月 1 日起，changefeed 对新创建的 TiDB Cloud Essential 实例按功能收费。有关计费详情，请参见 [TiDB Cloud Essential Pricing Details](https://www.pingcap.com/tidb-cloud-essential-pricing-details/)。
