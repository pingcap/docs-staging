...
从你的项目中删除一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例：
...
以交互模式删除一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例：

```shell
ticloud serverless delete
```

以非交互模式删除一个 TiDB Cloud Starter 或 TiDB Cloud Essential 实例：
...
| --force                   | 无需确认直接删除 TiDB Cloud Starter 或 Essential 实例。                       | 否       | 在非交互和交互模式下均可用。                       |
