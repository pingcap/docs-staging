...
- SQL 编辑器仅适用于部署在 AWS 上的 [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) 实例。如需在 [TiDB Cloud Dedicated](/tidb-cloud/select-cluster-tier.md#tidb-cloud-dedicated) 集群上使用 SQL 编辑器和 Chat2Query，请联系 [TiDB Cloud support](/tidb-cloud/tidb-cloud-support.md)。
...
2. 点击你的 TiDB Cloud Starter 实例或 TiDB Cloud Dedicated 集群名称，然后在左侧导航栏点击 **SQL Editor**。
