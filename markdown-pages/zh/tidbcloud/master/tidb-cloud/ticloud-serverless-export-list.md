...
列出 TiDB Cloud Starter 和 TiDB Cloud Essential 实例的数据导出任务：
...
以非交互模式列出指定 TiDB Cloud Starter 或 Essential 实例的导出任务：

```shell
ticloud serverless export list -c <cluster-id>
```

以非交互模式并以 JSON 格式列出指定 TiDB Cloud Starter 或 Essential 实例的导出任务：
