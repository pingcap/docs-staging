...
4. [使用私有 endpoint 连接到你的 TiDB Cloud Starter 或 Essential 实例](#step-4-connect-to-your-instance-using-the-private-endpoint)
...
在阿里云上创建 interface endpoint 后，你可以为目标 TiDB Cloud Starter 或 TiDB Cloud Essential 实例授权该 endpoint 以限制访问。
...
### Step 4. 使用私有 endpoint 连接到你的 TiDB Cloud Starter 或 Essential 实例 {#step-4-connect-to-your-instance-using-the-private-endpoint}
