...
在尝试 HTAP 特性之前，请按照 [TiDB Cloud 快速入门](/tidb-cloud/tidb-cloud-quickstart.md) 创建一个 TiDB Cloud Starter 实例，然后按如下步骤将你的数据（本文档以 **Steam Games Dataset 2021-2025** 为例）导入到该实例中：
...
2. 打开你的 TiDB Cloud Starter 实例的 **Import** 页面。
    ...
    1. 在 [TiDB Cloud 控制台](https://tidbcloud.com/)中，进入 [**My TiDB**](https://tidbcloud.com/tidbs) 页面，然后点击目标 TiDB Cloud Starter 实例的名称，进入其实例概览页面。
