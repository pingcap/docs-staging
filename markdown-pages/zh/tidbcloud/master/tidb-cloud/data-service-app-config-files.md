...
| 字段   | 类型    | 说明  |
|---------|---------|--------------|
| `cluster_id` | Integer | 你的 TiDB Cloud Starter 实例的 ID。你可以从实例的 URL 获取它。例如，如果你的实例 URL 是 `https://tidbcloud.com/tidbs/1234567891234567890/overview?orgId=<organization-id>`，你的实例 ID 是 `1234567891234567890`。 |
...
| `cluster_id`  | String | 端点使用的 TiDB Cloud Starter 实例的 ID。你可以从实例的 URL 获取它。例如，如果你的实例 URL 是 `https://tidbcloud.com/tidbs/1234567891234567890/overview?orgId=<organization-id>`，实例 ID 是 `1234567891234567890`。 |
