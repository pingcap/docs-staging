...
> **Tip:**
>
> - 如果你想了解如何通过 AWS PrivateLink 连接到 TiDB Cloud Starter 或 TiDB Cloud Essential 集群，请参见 [Connect to TiDB Cloud Starter or Essential via AWS PrivateLink](/tidb-cloud/set-up-private-endpoint-connections-serverless.md)。
