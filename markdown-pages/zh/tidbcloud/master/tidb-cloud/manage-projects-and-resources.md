...
- TiDB X 实例，即一种面向服务的 TiDB Cloud 产品，基于 [TiDB X architecture](/tidb-cloud/tidb-x-architecture.md) 构建，例如 <CustomContent plan="starter,essential,dedicated">TiDB Cloud Starter 或 Essential</CustomContent><CustomContent plan="premium">TiDB Cloud Starter, Essential, 或 Premium</CustomContent> 实例
