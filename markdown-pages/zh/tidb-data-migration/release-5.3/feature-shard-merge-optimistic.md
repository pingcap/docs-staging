...
![optimistic-ddl-fail-example-1](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-fail-example-1.png)
...
![optimistic-ddl-fail-example-2](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-fail-example-2.png)
...
![optimistic-ddl-fail-example-3](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-fail-example-3.png)
...
![optimistic-ddl-flow](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-flow.png)

### 例子

例如上游 MySQL 有三个分表（`tbl00`, `tbl01` 以及 `tbl02`），使用 DM 迁移到下游 TiDB 的 `tbl` 表中，如下图所示：

![optimistic-ddl-example-1](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-1.png)
...
![optimistic-ddl-example-2](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-2.png)

此时下游 TiDB 要准备接受来自 `tbl00` 有 `Level` 的 DML、以及来自 `tbl01` 和 `tbl02` 没有 `Level` 的 DML。

![optimistic-ddl-example-3](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-3.png)
...
![optimistic-ddl-example-4](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-4.png)
...
![optimistic-ddl-example-5](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-5.png)
...
![optimistic-ddl-example-6](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-6.png)
...
![optimistic-ddl-example-7](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-7.png)
...
![optimistic-ddl-example-8](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-8.png)
...
![optimistic-ddl-example-9](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-9.png)
...
![optimistic-ddl-example-10](https://download.pingcap.com/images/tidb-data-migration/optimistic-ddl-example-10.png)
