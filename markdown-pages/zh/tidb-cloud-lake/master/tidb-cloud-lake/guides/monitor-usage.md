...
TiDB Cloud Lake 提供监控功能，帮助你全面了解你自己以及组织成员在平台上的使用情况。要访问 **Monitor** 页面，请在首页的侧边栏菜单中点击 **Monitor**。该页面包含以下标签页：
...
在 **SQL History** 页面点击某条记录后，可以查看 TiDB Cloud Lake 如何执行该 SQL 语句的详细信息，并访问以下标签页：
