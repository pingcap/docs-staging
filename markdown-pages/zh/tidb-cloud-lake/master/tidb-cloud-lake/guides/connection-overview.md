...
summary: TiDB Cloud Lake 支持多种连接方法，以适应不同的使用场景。以下所有选项同时适用于 **TiDB Cloud Lake** 和 **self-hosted TiDB Cloud Lake**。
---

# 连接到 TiDB Cloud Lake

TiDB Cloud Lake 支持多种连接方法，以适应不同的使用场景。
...
> **提示：**
>
> **TiDB Cloud Lake**：登录 → 点击 **Connect** → 复制生成的 DSN
