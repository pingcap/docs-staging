---
title: 集成任务
summary: 本页概述 TiDB Cloud Lake 中的集成任务。集成任务定义了数据如何从外部源流入 TiDB Cloud Lake，包括源设置、目标表和运行时参数。
---
...
| [Amazon SQS (S3) (Beta)](/tidb-cloud-lake/guides/integrate-with-amazon-sqs-s3.md) | 从 SQS 队列消费 S3 对象创建事件，并将相应的对象数据写入 TiDB Cloud Lake。 |
