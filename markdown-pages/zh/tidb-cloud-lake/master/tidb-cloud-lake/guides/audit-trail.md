---
title: 审计追踪
summary: "TiDB Cloud Lake system history tables 会自动捕获数据库活动的详细记录，为合规性和安全监控提供完整的审计追踪。"
---

# 审计追踪

TiDB Cloud Lake system history tables 会自动捕获数据库活动的详细记录，为合规性和安全监控提供完整的审计追踪。
...
TiDB Cloud Lake 提供了三个 system history tables，用于捕获数据库活动的不同方面：
