---
title: "TiDB Cloud Lake vs. Snowflake: 数据摄取基准测试"
summary: 本页展示了 TiDB Cloud Lake 与 Snowflake 在数据摄取性能和成本方面的基准对比，重点关注 TPC-H SF100 数据集加载、ClickBench Hits 数据集加载以及新鲜度基准测试。
---
...
- **[TiDB Cloud Lake](https://tidbcloud.com)**：云原生数据仓库，专注于扩展性和成本效益。
...
| 指标         | Snowflake | TiDB Cloud Lake | 描述            |
| -------------- | --------- | -------------- | ---------------------- |
...
1. 在 TiDB Cloud Lake 中创建一个 [外部 Stage](/tidb-cloud-lake/sql/create-stage.md#example-2-create-external-stage-with-connection)。
