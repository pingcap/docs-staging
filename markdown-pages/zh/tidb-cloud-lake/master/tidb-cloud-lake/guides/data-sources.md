---
title: 数据源
summary: "TiDB Cloud Lake 中的数据源表示与外部系统的连接。它存储访问外部系统所需的凭证和连接详细信息，并可在多个集成任务或通知场景中复用。"
---

# 数据源

TiDB Cloud Lake 中的数据源表示与外部系统的连接。它存储访问外部系统所需的凭证和连接详细信息，并可在多个集成任务或通知场景中复用。
