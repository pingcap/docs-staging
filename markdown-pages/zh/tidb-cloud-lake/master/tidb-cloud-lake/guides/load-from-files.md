...
TiDB Cloud Lake 提供简单而强大的命令，可将数据文件加载到表中。大多数操作只需一条命令。你的数据必须采用[支持的格式](/tidb-cloud-lake/sql/input-output-file-formats.md)。
...
| **本地文件** | [**LakeSQL**](https://github.com/tidbcloud/lakesql) | TiDB Cloud Lake 的原生 CLI 工具，用于加载本地文件 | [从本地文件加载](/tidb-cloud-lake/guides/load-from-local-file.md) |
