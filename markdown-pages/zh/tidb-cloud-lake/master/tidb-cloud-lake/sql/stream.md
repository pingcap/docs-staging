---
title: Stream
summary: 本页按功能组织，全面概述了 TiDB Cloud Lake 中的 stream 操作，便于快速查阅。
---

# Stream

本页按功能组织，全面概述了 TiDB Cloud Lake 中的 stream 操作，便于快速查阅。
...
> **注意：**
>
> TiDB Cloud Lake 中的 streams 用于跟踪和捕获表的变更，从而支持持续的数据管道和实时数据处理。