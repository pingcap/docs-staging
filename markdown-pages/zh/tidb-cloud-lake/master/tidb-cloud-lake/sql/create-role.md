---
title: CREATE ROLE
summary: 创建一个新的角色用于访问控制。角色用于对权限进行分组，并且可以分配给用户或其他角色，从而在 TiDB Cloud Lake 中提供一种灵活的权限管理方式。
---

# CREATE ROLE

创建一个新的角色用于访问控制。角色用于对权限进行分组，并且可以分配给用户或其他角色，从而在 TiDB Cloud Lake 中提供一种灵活的权限管理方式。
