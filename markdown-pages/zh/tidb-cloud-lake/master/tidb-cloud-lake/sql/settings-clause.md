---
title: SETTINGS 子句
summary: SETTINGS 子句用于配置会影响其前置 SQL 语句执行行为的特定设置。要查看 TiDB Cloud Lake 中可用的设置及其值，请使用 SHOW SETTINGS。
---

# SETTINGS 子句

SETTINGS 子句用于配置会影响其前置 SQL 语句执行行为的特定设置。要查看 TiDB Cloud Lake 中可用的设置及其值，请使用 [SHOW SETTINGS](/tidb-cloud-lake/sql/show-settings.md)。
