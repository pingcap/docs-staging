---
title: Map 函数
summary: 本节提供 TiDB Cloud Lake 中 map 函数的参考信息。Map 函数可用于创建、操作以及从 map 数据结构（键值对）中提取信息。
---

# Map 函数

本节提供 TiDB Cloud Lake 中 map 函数的参考信息。Map 函数可用于创建、操作以及从 map 数据结构（键值对）中提取信息。
