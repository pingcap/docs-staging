---
title: Stage
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中的 stage 操作，便于参考。
---

# Stage

本页按功能分类，全面概述了 TiDB Cloud Lake 中的 stage 操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的 stage 用作临时存储位置，用于保存你希望加载到表中或从表中卸载的数据文件。