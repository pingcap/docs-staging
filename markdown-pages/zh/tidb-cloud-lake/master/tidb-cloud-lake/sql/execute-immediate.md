...
summary: 执行 SQL 脚本。有关如何为 TiDB Cloud Lake 编写 SQL 脚本，请参见 Stored Procedure & SQL Scripting。
---

# EXECUTE IMMEDIATE

执行 SQL 脚本。有关如何为 TiDB Cloud Lake 编写 SQL 脚本，请参见 [存储过程与 SQL 脚本](/tidb-cloud-lake/sql/stored-procedure-scripting.md)。
