...
- 你也可以使用 `SELECT TO_TIMESTAMP('994518299', '%s')` 进行转换，但不推荐这样做。对于此类转换，TiDB Cloud Lake 建议使用上面的示例方法以获得更好的性能。

- Timestamp 的取值范围是 1000-01-01 00:00:00.000000 到 9999-12-31 23:59:59.999999。如果你运行以下语句，TiDB Cloud Lake 会返回错误：
