...
| 参数 | 描述 |
|-----------|-------------|
| ROLE_ARN  | TiDB Cloud Lake 将用于访问你的 S3 资源的 IAM 角色的 Amazon Resource Name (ARN)。 |
...
> **Note:**
>
> 要在 TiDB Cloud Lake 中使用 IAM 角色，你需要在你的 AWS 账户与 TiDB Cloud Lake 之间建立信任关系。详细说明请参见 [使用 AWS IAM Role 进行认证](/tidb-cloud-lake/guides/authenticate-with-aws-iam-role.md)。