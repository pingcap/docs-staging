---
title: 脱敏策略
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中脱敏策略的相关操作，便于参考。
---

# 脱敏策略

本页按功能分类，全面概述了 TiDB Cloud Lake 中脱敏策略的相关操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的脱敏策略允许你在缺少适当权限的用户查询数据时，通过动态转换或混淆数据来保护敏感信息。