---
title: Cluster Key
summary: 本页按功能组织，全面概述了 TiDB Cloud Lake 中的 cluster key 操作，便于参考。
---

# Cluster Key

本页按功能组织，全面概述了 TiDB Cloud Lake 中的 cluster key 操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的 cluster key 用于在表中以物理方式组织数据，通过将相关数据放置在一起以提升查询性能。