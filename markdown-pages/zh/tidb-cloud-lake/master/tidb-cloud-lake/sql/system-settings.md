...
| hive_parquet_chunk_size | 16384 | 16384 | DEFAULT | 每次从 parquet 读取到 TiDB Cloud Lake 处理器的最大行数。 | UInt64 |
...
| query_result_cache_allow_inconsistent | 0 | 0 | DEFAULT | 决定 TiDB Cloud Lake 是否返回与底层数据不一致的缓存查询结果。 | UInt64 |
