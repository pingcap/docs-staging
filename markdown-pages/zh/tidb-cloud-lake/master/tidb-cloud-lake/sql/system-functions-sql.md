---
title: 系统函数
summary: 本页提供 TiDB Cloud Lake 中与系统相关的函数参考信息。这些函数可帮助你分析和监控 TiDB Cloud Lake 部署的内部存储和性能相关方面。
---

# 系统函数

本页提供 TiDB Cloud Lake 中与系统相关的函数参考信息。这些函数可帮助你分析和监控 TiDB Cloud Lake 部署的内部存储和性能相关方面。
