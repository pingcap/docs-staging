---
title: UUID 函数
summary: 本页提供 TiDB Cloud Lake 中与 UUID 相关函数的参考信息。这些函数用于生成和处理通用唯一标识符（UUID）。
---

# UUID 函数

本页提供 TiDB Cloud Lake 中与 UUID 相关函数的参考信息。这些函数用于生成和处理通用唯一标识符（UUID）。
