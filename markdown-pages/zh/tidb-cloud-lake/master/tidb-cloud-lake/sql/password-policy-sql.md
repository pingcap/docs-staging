---
title: 密码策略
summary: 本页按功能分类，全面介绍 TiDB Cloud Lake 中 Password Policy 的相关操作，便于快速查阅。
---

# 密码策略

本页按功能分类，全面介绍 TiDB Cloud Lake 中 Password Policy 的相关操作，便于快速查阅。
...
> **注意：**
>
> TiDB Cloud Lake 中的密码策略可用于对用户密码强制执行安全要求，例如最小长度、复杂度和过期规则。