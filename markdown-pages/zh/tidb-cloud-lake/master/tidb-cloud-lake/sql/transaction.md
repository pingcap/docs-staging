---
title: 事务
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中的事务操作，便于参考。
---

# 事务

本页按功能分类，全面概述了 TiDB Cloud Lake 中的事务操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的事务通过将 SQL 操作分组为原子单元来确保数据一致性，这些操作要么全部成功，要么全部失败，从而维护数据库完整性。