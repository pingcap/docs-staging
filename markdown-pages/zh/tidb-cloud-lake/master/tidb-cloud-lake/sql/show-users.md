---
title: SHOW USERS
summary: 列出系统中的所有 SQL 用户。如果你使用的是 TiDB Cloud Lake，此命令还会显示你所在组织中用于登录 TiDB Cloud Lake 的用户账户（电子邮件地址）。
---

# SHOW USERS

列出系统中的所有 SQL 用户。如果你使用的是 TiDB Cloud Lake，此命令还会显示你所在组织中用于登录 TiDB Cloud Lake 的用户账户（电子邮件地址）。
