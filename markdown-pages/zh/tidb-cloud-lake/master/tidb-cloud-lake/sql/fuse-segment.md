---
title: FUSE_SEGMENT
summary: 返回指定表快照的 segment 信息。有关 TiDB Cloud Lake 中 segment 的更多信息，请参阅什么是 Snapshot、Segment 和 Block？。
---

# FUSE_SEGMENT

返回指定表快照的 segment 信息。有关 TiDB Cloud Lake 中 segment 的更多信息，请参阅 [什么是 Snapshot、Segment 和 Block？](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block)。
