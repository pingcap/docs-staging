---
title: 查询语法
summary: 本页提供 TiDB Cloud Lake 中查询语法的参考信息。每个组件都可以单独使用，也可以组合使用以构建强大的查询。
---

# 查询语法

本页提供 TiDB Cloud Lake 中查询语法的参考信息。每个组件都可以单独使用，也可以组合使用以构建强大的查询。
...
一个典型的 TiDB Cloud Lake 查询遵循以下结构：
