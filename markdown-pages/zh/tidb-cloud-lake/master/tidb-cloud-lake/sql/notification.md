---
title: 通知
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中的 Notification 操作，便于参考。
---

# 通知

本页按功能分类，全面概述了 TiDB Cloud Lake 中的 Notification 操作，便于参考。
...
> **Note:**
>
> TiDB Cloud Lake 中的 Notification 允许你配置与电子邮件或 Slack 等外部服务的集成，以接收有关数据库事件和操作的告警。