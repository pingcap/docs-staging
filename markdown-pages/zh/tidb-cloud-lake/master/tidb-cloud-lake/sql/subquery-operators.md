---
title: 子查询运算符
summary: 子查询是嵌套在另一个查询中的查询。TiDB Cloud Lake 支持以下子查询类型。
---

# 子查询运算符

子查询是嵌套在另一个查询中的查询。TiDB Cloud Lake 支持以下子查询类型：
...
- 如果标量子查询返回 0 行，TiDB Cloud Lake 会使用 NULL 作为子查询输出。
- 如果标量子查询返回多于一行，TiDB Cloud Lake 会抛出错误。
