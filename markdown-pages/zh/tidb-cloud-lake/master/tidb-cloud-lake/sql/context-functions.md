---
title: 上下文函数
summary: 本页提供 TiDB Cloud Lake 中与上下文相关的函数参考信息。这些函数返回当前会话、数据库或系统上下文的信息。
---

# 上下文函数

本页提供 TiDB Cloud Lake 中与上下文相关的函数参考信息。这些函数返回当前会话、数据库或系统上下文的信息。
...
| 函数 | 描述 | 示例 |
|----------|-------------|--------|
| [VERSION](/tidb-cloud-lake/sql/version.md) | 返回 TiDB Cloud Lake 的当前版本 | `VERSION()` → `'LakeQuery v1.2.252-nightly-193ed56304'` |