---
title: Ngram Index
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中 Ngram 索引的相关操作，便于快速查阅。
---

# Ngram 索引

本页按功能分类，全面概述了 TiDB Cloud Lake 中 Ngram 索引的相关操作，便于快速查阅。
...
> **注意：**
>
> TiDB Cloud Lake 中的 Ngram 索引支持在文本数据中高效执行子字符串搜索和模式匹配，从而提升 LIKE 及类似操作的性能。