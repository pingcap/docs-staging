...
summary: 恢复已删除数据库的最新版本。此功能利用 TiDB Cloud Lake Time Travel 特性；已删除对象只能在保留时间内恢复（默认为 24 小时）。
---

# UNDROP DATABASE

恢复已删除数据库的最新版本。此功能利用 TiDB Cloud Lake Time Travel 特性；已删除对象只能在保留时间内恢复（默认为 24 小时）。
