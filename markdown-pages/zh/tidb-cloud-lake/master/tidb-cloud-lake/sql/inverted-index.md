---
title: 倒排索引
summary: 本页按功能分类，全面概述 TiDB Cloud Lake 中的倒排索引操作，便于参考。
---

# 倒排索引

本页按功能分类，全面概述 TiDB Cloud Lake 中的倒排索引操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的倒排索引可为文本数据提供高效的全文搜索能力，从而支持在大型文本列中快速执行关键字搜索。