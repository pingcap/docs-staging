---
title: 视图
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中的视图操作，便于快速查阅。
---

# 视图

本页按功能分类，全面概述了 TiDB Cloud Lake 中的视图操作，便于快速查阅。
...
> **Note:**
>
> TiDB Cloud Lake 中的视图是存储在数据库中的命名查询，可以像表一样被引用。它们可用于简化复杂查询，并控制对底层数据的访问。