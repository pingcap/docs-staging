---
title: UNDROP TABLE
summary: 恢复最近版本的已删除表。此功能利用 TiDB Cloud Lake Time Travel 特性；已删除对象只能在保留时间内恢复（默认为 24 小时）。
---

# UNDROP TABLE

恢复最近版本的已删除表。此功能利用 TiDB Cloud Lake Time Travel 特性；已删除对象只能在保留时间内恢复（默认为 24 小时）。
