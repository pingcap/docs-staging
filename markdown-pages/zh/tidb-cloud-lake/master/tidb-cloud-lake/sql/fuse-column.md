---
title: FUSE_COLUMN
summary: 返回表的最新或指定快照的列信息。有关 TiDB Cloud Lake 中 block 的更多信息，请参阅什么是 Snapshot、Segment 和 Block？。
---

# FUSE_COLUMN

返回表的最新或指定快照的列信息。有关 TiDB Cloud Lake 中 block 的更多信息，请参阅[什么是 Snapshot、Segment 和 Block？](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block)。
