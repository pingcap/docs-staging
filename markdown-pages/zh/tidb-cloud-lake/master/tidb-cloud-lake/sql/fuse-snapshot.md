---
title: FUSE_SNAPSHOT
summary: 返回表的快照信息。有关 TiDB Cloud Lake 中快照的更多信息，请参阅什么是 Snapshot、Segment 和 Block？。
---

# FUSE_SNAPSHOT

返回表的快照信息。有关 TiDB Cloud Lake 中快照的更多信息，请参阅[什么是 Snapshot、Segment 和 Block？](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block)。
