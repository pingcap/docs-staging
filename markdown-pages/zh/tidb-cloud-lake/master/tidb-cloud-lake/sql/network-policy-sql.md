---
title: 网络策略
summary: 本页按功能分类，全面概述了 TiDB Cloud Lake 中的网络策略操作，便于参考。
---

# 网络策略

本页按功能分类，全面概述了 TiDB Cloud Lake 中的网络策略操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的网络策略允许你通过指定允许或阻止的 IP 地址及地址范围来控制对数据库的访问。