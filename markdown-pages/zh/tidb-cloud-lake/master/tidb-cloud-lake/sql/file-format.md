---
title: 文件格式
summary: 本页按功能组织，全面概述了 TiDB Cloud Lake 中的文件格式操作，便于参考。
---

# 文件格式

本页按功能组织，全面概述了 TiDB Cloud Lake 中的文件格式操作，便于参考。
...
> **注意：**
>
> TiDB Cloud Lake 中的文件格式定义了在数据加载操作期间应如何解析数据文件，或在数据卸载操作期间应如何设置数据文件的格式。它们提供了一种可复用的方式，用于指定文件类型、字段分隔符、压缩方式以及其他格式选项。