---
title: 系统表
summary: "TiDB Cloud Lake 提供了一组系统表，其中包含有关你的 TiDB Cloud Lake 部署、数据库、表、查询和系统性能的元信息。这些表为只读，并由系统自动更新。"
---

# 系统表

TiDB Cloud Lake 提供了一组系统表，其中包含有关你的 TiDB Cloud Lake 部署、数据库、表、查询和系统性能的元信息。这些表为只读，并由系统自动更新。

系统表组织在 `system` schema 中，可以使用标准 SQL 进行查询。它们为监控、故障排查以及了解你的 TiDB Cloud Lake 环境提供了有价值的信息。
...
| 表 | 描述 |
|-------|-------------|
| [system.build_options](/tidb-cloud-lake/sql/system-build-options.md) | 包含用于编译 TiDB Cloud Lake 的构建选项信息。 |
| [system.clusters](/tidb-cloud-lake/sql/system-clusters.md) | 包含系统中集群的信息。 |
| [system.contributors](/tidb-cloud-lake/sql/system-contributors.md) | 列出 TiDB Cloud Lake 项目的贡献者。 |
| [system.credits](/tidb-cloud-lake/sql/system-credits.md) | 包含 TiDB Cloud Lake 使用的第三方库信息。 |
