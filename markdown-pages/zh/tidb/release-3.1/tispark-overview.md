...
![TiSpark Architecture](https://docs-download.pingcap.com/media/images/docs-cn/tispark-architecture.png)
...
如果希望使用统计信息支持，需要确保所涉及的表已经被分析。请阅读[这份文档](https://pingcap.com/docs-cn/v3.1/reference/performance/statistics/)了解如何进行表分析。
