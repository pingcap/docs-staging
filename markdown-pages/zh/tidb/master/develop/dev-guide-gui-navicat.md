...
6. 在 **New Connection (TiDB)** 对话框中，配置以下连接参数：
    ...
    ![Navicat: configure connection general panel for TiDB Cloud Serverless](https://docs-download.pingcap.com/media/images/docs-cn/develop/navicat-premium-connection-config-serverless-general.png)
...
7. 点击 **SSL** 选项卡，选择 **Use SSL**，**Use authentication** 以及 **Verify server certificate against CA** 复选框。并在 **CA Certificate** 字段中填入从 TiDB Cloud 连接对话框中获取的 `CA` 文件路径。
    ...
    ![Navicat: configure connection SSL panel for TiDB Cloud Serverless](https://docs-download.pingcap.com/media/images/docs-cn/develop/navicat-premium-connection-config-serverless-ssl.png)
