...
![TPC-C](https://download.pingcap.com/images/docs-cn/performance/tpcc_cpu_memory.png)
...
![TPC-C](https://download.pingcap.com/images/docs-cn/performance/tpcc_read_write_traffic.png)
...
- 启用 Titan 前的写流量
    ...
    ![Titan 禁用](https://download.pingcap.com/images/docs-cn/performance/titan_disable.png)
...
- 启用 Titan 后的写流量
    ...
    ![Titan 启用](https://download.pingcap.com/images/docs-cn/performance/titan_enable.png)
