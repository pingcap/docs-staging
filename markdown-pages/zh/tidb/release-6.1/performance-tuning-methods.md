...
![TPC-C](https://docs-download.pingcap.com/media/images/docs-cn/performance/tpcc_kv_conn.png)
...
![OLTP](https://docs-download.pingcap.com/media/images/docs-cn/performance/cloud_long_idle_kv_conn.png)
...
![TiDB is the Bottleneck](https://docs-download.pingcap.com/media/images/docs-cn/performance/cloud_query_long_idle.png)
...
从 v6.1.0 起，TiDB Grafana 组件默认内置了 Performance Overview 面板。Performance overview 面板兼容 TiDB v4.x 和 v5.x 版本。如果你的 TiDB 版本低于 v6.1.0，需要手动导入 [`performance_overview.json`](https://github.com/pingcap/tidb/blob/release-6.1/metrics/grafana/performance_overview.json)。
