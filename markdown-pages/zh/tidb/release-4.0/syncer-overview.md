---
title: Syncer 使用文档
aliases: ['/docs-cn/stable/syncer-overview/','/docs-cn/v4.0/syncer-overview/','/docs-cn/stable/reference/tools/syncer/','/zh/tidb/stable/syncer-overview']
---
...
Syncer 包含在 tidb-enterprise-tools 安装包中，可[在此下载](/download-ecosystem-tools.md)。
...
6. 检查字符集。
    ...
    TiDB 和 MySQL 的字符集的兼容性不同，详见 [TiDB 支持的字符集](/character-set-and-collation.md)。
