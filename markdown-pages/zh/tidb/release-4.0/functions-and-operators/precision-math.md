---
title: 精度数学
aliases: ['/docs-cn/stable/functions-and-operators/precision-math/','/docs-cn/v4.0/functions-and-operators/precision-math/','/docs-cn/stable/reference/sql/functions-and-operators/precision-math/']
---
