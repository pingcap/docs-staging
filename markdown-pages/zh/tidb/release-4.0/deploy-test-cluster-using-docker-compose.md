...
aliases: ['/docs-cn/stable/deploy-test-cluster-using-docker-compose/','/docs-cn/v4.0/deploy-test-cluster-using-docker-compose/','/docs-cn/stable/how-to/get-started/deploy-tidb-from-docker-compose/']
---
