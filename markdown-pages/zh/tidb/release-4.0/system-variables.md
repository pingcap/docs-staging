---
title: 系统变量
aliases: ['/docs-cn/stable/system-variables/','/docs-cn/v4.0/system-variables/','/docs-cn/stable/reference/configuration/tidb-server/mysql-variables/','/docs-cn/stable/tidb-specific-system-variables/','/docs-cn/stable/reference/configuration/tidb-server/tidb-specific-variables/','/zh/tidb/stable/tidb-specific-system-variables/','/zh/tidb/v4.0/tidb-specific-system-variables/']
---
...
- 这个变量设置了 [statement summary tables](/statement-summary-tables.md) 的刷新时间，单位为秒。
