...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-show-table-status/','/docs-cn/v4.0/sql-statements/sql-statement-show-table-status/','/docs-cn/stable/reference/sql/statements/show-table-status/','/docs-cn/v4.0/reference/sql/statements/show-table-status/']
---
