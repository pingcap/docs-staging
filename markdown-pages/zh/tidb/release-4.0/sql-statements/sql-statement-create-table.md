...
aliases: ['/docs-cn/stable/sql-statements/sql-statement-create-table/','/docs-cn/v4.0/sql-statements/sql-statement-create-table/','/docs-cn/stable/reference/sql/statements/create-table/']
---
