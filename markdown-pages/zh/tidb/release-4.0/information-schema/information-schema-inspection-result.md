...
aliases: ['/docs-cn/stable/system-tables/system-table-inspection-result/','/docs-cn/v4.0/system-tables/system-table-inspection-result/','/docs-cn/stable/reference/system-databases/inspection-result/','/zh/tidb/stable/system-table-inspection-result/','/docs-cn/v4.0/reference/system-databases/inspection-result/','/zh/tidb/v4.0/system-table-inspection-result/']
---
