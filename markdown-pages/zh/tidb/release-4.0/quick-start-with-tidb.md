...
aliases: ['/docs-cn/stable/quick-start-with-tidb/','/docs-cn/v4.0/quick-start-with-tidb/','/docs-cn/stable/how-to/get-started/local-cluster/install-from-docker-compose/','/docs-cn/op-guide/docker-compose/']
---
