...
aliases: ['/docs-cn/stable/dashboard/dashboard-statement-list/','/docs-cn/v4.0/dashboard/dashboard-statement-list/']
---
...
- 登录后，左侧导航条点击**SQL 语句分析**（SQL Statements）：
  ...
  ![访问](https://docs-download.pingcap.com/media/images/docs-cn/dashboard/dashboard-statement-access.png)
