...
- 探索数据
  - [使用 AI 辅助 SQL 编辑器 Chat2Query](/ai/explore-data-with-chat2query.md) ![BETA](https://docs-download.pingcap.com/media/images/docs-cn/tidb-cloud/blank_transparent_placeholder.png)
  - [配置 SQL 代理账户](/ai/sql-proxy-account.md)
- 向量搜索 [!BETA](https://docs-download.pingcap.com/media/images/docs-cn/tidb-cloud/blank_transparent_placeholder.png)
