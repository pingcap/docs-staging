...
![TiCDC Summary Dashboard - Overview](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor.png)
...
![TiCDC Summary Dashboard - Server metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-server.png)
...
![TiCDC Summary Dashboard - Changefeed metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-changefeed.png)
...
![TiCDC Summary Dashboard - Puller metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-dataflow-puller.png)
...
![TiCDC Summary Dashboard - Sorter metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-dataflow-sorter.png)
...
![TiCDC Summary Dashboard - Mounter metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-dataflow-mounter.png)
...
![TiCDC Summary Dashboard - Sink metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-dataflow-sink.png)
...
![TiCDC Summary Dashboard - Transaction Sink metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-transaction-sink.png)
...
![TiCDC Summary Dashboard - Transaction Sink metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-mq-sink.png)
...
![TiCDC Summary Dashboard - Transaction Sink metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-cloud-storage.png)
...
![TiCDC Summary Dashboard - Transaction Sink metrics](https://download.pingcap.com/images/docs-cn/ticdc/ticdc-summary-monitor-redo.png)
