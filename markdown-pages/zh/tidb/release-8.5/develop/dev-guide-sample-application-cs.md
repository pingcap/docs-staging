...
- 你需要有一个可用的 TiDB 实例。可以使用 [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter) 实例或 [TiDB Cloud Dedicated](https://docs.pingcap.com/tidbcloud/select-cluster-tier/#tidb-cloud-dedicated) 集群，或自托管的 TiDB 集群（如通过 `tiup playground` 启动的集群）。
...
Connected to: 8.0.11-TiDB-v8.5.7
...
Git Branch: HEAD
UTC Build Time: 2026-07-09 03:30:55
GoVersion: go1.23.8
Race Enabled: false
