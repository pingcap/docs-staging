...
如果你的 TiDB Self-Managed 集群使用 [TiUP](/tiup/tiup-reference.md#tiup-命令概览) 部署或者你可以直接连接到你的 TiDB 服务器，你可以通过如下命令快速生成并导入 Bookshop 应用的示例数据：
...
1. 打开目标 TiDB Cloud 资源的 **Import** 页面。

    1. 登录 [TiDB Cloud](https://tidbcloud.com/)，导航至 [**My TiDB**](https://tidbcloud.com/tidbs) 页面。
