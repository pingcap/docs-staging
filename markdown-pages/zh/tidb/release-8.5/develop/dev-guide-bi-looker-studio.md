...
3. 在 **BASIC** 设置面板中，配置连接参数。
    ...
    ![Looker Studio: 配置 TiDB Cloud Starter 连接设置](https://docs-download.pingcap.com/media/images/docs-cn/tidb-cloud/looker-studio-configure-connection.png)
...
1. 在右侧面板点击 **CUSTOM QUERY**。
    ...
    ![Looker Studio: 自定义查询](https://docs-download.pingcap.com/media/images/docs-cn/tidb-cloud/looker-studio-custom-query.png)
...
![Looker Studio: 一个简单的组合图表](https://docs-download.pingcap.com/media/images/docs-cn/tidb-cloud/looker-studio-simple-chart.png)
