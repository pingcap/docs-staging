...
> - 向量搜索功能可用于 [TiDB Self-Managed](/overview.md) 和 [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier/?plan=starter#starter)。对于 TiDB Self-Managed，TiDB 版本必须为 v8.4.0 或更高版本（推荐使用 v8.5.0 或更高版本）。
...
![TiDB 向量搜索示意图](https://docs-download.pingcap.com/media/images/docs-cn/vector-search/embedding-search.png)
