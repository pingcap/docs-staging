...
本教程演示如何将 [TiDB 向量搜索](/ai/guides/vector-search-overview.md) 与 [LlamaIndex](https://www.llamaindex.ai) 集成。
...
对于 TiDB Cloud TiDB Cloud Starter 实例，按以下步骤获取连接字符串并配置环境变量：

1. 进入 [**My TiDB**](https://tidbcloud.com/tidbs) 页面，点击目标 TiDB Cloud TiDB Cloud Starter 实例名称进入其概览页面。
