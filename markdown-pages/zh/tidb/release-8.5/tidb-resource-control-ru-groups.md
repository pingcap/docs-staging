...
aliases: ['/zh/tidb/v8.5/tidb-resource-control/','/zh/tidb/stable/tidb-resource-control/']
---
...
> - 上表只列举了本地部署的 TiDB 计算 RU 时涉及的相关资源，其中不包括网络和存储部分。TiDB Cloud Starter 的 RU 可参考 [TiDB Cloud Starter Pricing Details](https://www.pingcap.com/tidb-cloud-starter-pricing-details/)。
