...
aliases: ['/zh/tidb/dev/release-7.0.0/','/zh/tidb/v7.0/release-7.0.0','/zh/tidb/v5.4/release-7.0.0','/zh/tidb/v6.1/release-7.0.0','/zh/tidb/v6.5/release-7.0.0','/zh/tidb/v7.1/release-7.0.0','/zh/tidb/v7.5/release-7.0.0','/zh/tidb/v8.1/release-7.0.0']
---
...
* [DBeaver](https://dbeaver.io/) v23.0.1 默认支持 TiDB [#17396](https://github.com/dbeaver/dbeaver/issues/17396) @[Icemap](https://github.com/Icemap)
    ...
    - 默认配置支持 [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter)，你可以更方便地连接 TiDB Cloud Starter。
