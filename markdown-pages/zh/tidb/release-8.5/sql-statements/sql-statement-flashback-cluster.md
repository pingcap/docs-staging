...
> **Warning:**
>
> `FLASHBACK CLUSTER TO [TIMESTAMP|TSO]` 语法不适用于 [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter)、[TiDB Cloud Essential](https://docs.pingcap.com/tidbcloud/select-cluster-tier#essential) 和 [TiDB Cloud Premium](https://docs.pingcap.com/tidbcloud/select-cluster-tier#premium) 实例。为避免出现不可预期的结果，请不要在 TiDB Cloud Starter、Essential 和 Premium 实例上执行该语句。
