...
TiDB 支持单独为整个集合运算进行 [`ORDER BY`](https://download.pingcap.com/images/docs-cn/sqlgram/OrderByOptional.png) 或者 [`LIMIT`](https://download.pingcap.com/images/docs-cn/sqlgram/LimitClause.png)。
