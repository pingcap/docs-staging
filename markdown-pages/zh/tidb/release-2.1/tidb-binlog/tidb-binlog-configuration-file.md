...
aliases: ['/docs-cn/v2.1/tidb-binlog/tidb-binlog-configuration-file/','/docs-cn/v2.1/reference/tidb-binlog/configs/']
---
...
* 默认：`0`。Drainer 会从每个 pump 最老的时间点开始拉取数据。
