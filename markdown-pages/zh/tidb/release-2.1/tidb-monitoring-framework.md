...
![Prometheus in TiDB](https://docs-download.pingcap.com/media/images/docs-cn/prometheus-in-tidb-v2.1.png)

Grafana 是一个开源的 metric 分析及可视化系统。我们使用 Grafana 来展示 TiDB 的各项性能指标。如下图所示:

![Grafana Screeshot](https://docs-download.pingcap.com/media/images/docs-cn/grafana-screenshot-v2.1.png)
