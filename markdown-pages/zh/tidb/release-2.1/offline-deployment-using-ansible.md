...
aliases: ['/docs-cn/v2.1/offline-deployment-using-ansible/','/docs-cn/v2.1/how-to/deploy/orchestrated/offline-ansible/']
---
...
3. 参考[部署任务](/online-deployment-using-ansible.md#第-11-步部署-tidb-集群)即可。
