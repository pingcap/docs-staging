...
* 登录后，左侧导航条点击**集群诊断** (Cluster Diagnose)：
    ...
    ![访问](https://docs-download.pingcap.com/media/images/docs-cn/dashboard/dashboard-diagnostics-access.png)
...
![生成单个时间段的诊断报告](https://docs-download.pingcap.com/media/images/docs-cn/dashboard/dashboard-diagnostics-gen-report.png)
...
![生成报告的进度](https://docs-download.pingcap.com/media/images/docs-cn/dashboard/dashboard-diagnostics-gen-process.png)
...
![生成对比报告](https://docs-download.pingcap.com/media/images/docs-cn/dashboard/dashboard-diagnostics-gen-compare-report.png)
