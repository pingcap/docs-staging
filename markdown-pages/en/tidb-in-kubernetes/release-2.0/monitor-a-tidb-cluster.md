...
5. Download Grafana dashboards for TiDB components using the [`get-grafana-dashboards.sh`](<https://raw.githubusercontent.com/pingcap/tidb-operator/refs/tags/v2.0.0-beta.0/hack/get-grafana-dashboards.sh>) script and import them manually into Grafana.
