...
2. Deploy local volume provisioner.
    ...
    3. According to the mounting configuration, modify the [local-volume-provisioner.yaml](<https://raw.githubusercontent.com/pingcap/tidb-operator/v1.6.3/manifests/eks/local-volume-provisioner.yaml>) file.
