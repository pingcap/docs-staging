...
For details on the deployment, refer to [this example of integrating TidbMonitor with Thanos Receiver](<https://github.com/pingcap/tidb-operator/tree/v1.6.3/examples/monitor-prom-remotewrite>).
