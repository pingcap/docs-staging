...
To configure the DM deployment, you need to configure the `DMCluster` Custom Resource (CR). For the complete configurations of the `DMCluster` CR, refer to the [DMCluster example](<https://github.com/pingcap/tidb-operator/blob/v1.6.3/examples/dm/dm-cluster.yaml>) and [API documentation](<https://github.com/pingcap/tidb-operator/blob/v1.6.3/docs/api-references/docs.md#dmcluster>). Note that you need to choose the example and API of the current TiDB Operator version.
