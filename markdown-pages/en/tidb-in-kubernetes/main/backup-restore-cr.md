...
* `.spec.toolImage`: the tools image used by `Restore`. For example, `spec.toolImage: pingcap/br:v8.5.2`. If not specified, `pingcap/br:${tikv_version}` is used for restoring by default.
