...
2. Deploy the TiDB cluster:
    ...
    To deploy a TiDB cluster, you need the following Docker images (assuming the version of the TiDB cluster is v8.5.5):

    ```shell
    pingcap/pd:v8.5.5
    pingcap/tikv:v8.5.5
    pingcap/tidb:v8.5.5
    pingcap/ticdc:v8.5.5
    pingcap/tiflash:v8.5.5
    pingcap/tiproxy:latest
    pingcap/tidb-monitor-reloader:v1.0.1
    pingcap/tidb-monitor-initializer:v8.5.5
    ...
    ```shell
    docker pull pingcap/pd:v8.5.5
    docker pull pingcap/tikv:v8.5.5
    docker pull pingcap/tidb:v8.5.5
    docker pull pingcap/ticdc:v8.5.5
    docker pull pingcap/tiflash:v8.5.5
    docker pull pingcap/tiproxy:latest
    docker pull pingcap/tidb-monitor-reloader:v1.0.1
    docker pull pingcap/tidb-monitor-initializer:v8.5.5
    docker pull grafana/grafana:7.5.11
    docker pull prom/prometheus:v2.18.1
    docker pull busybox:1.26.2

    docker save -o pd-v8.5.5.tar pingcap/pd:v8.5.5
    docker save -o tikv-v8.5.5.tar pingcap/tikv:v8.5.5
    docker save -o tidb-v8.5.5.tar pingcap/tidb:v8.5.5
    docker save -o ticdc-v8.5.5.tar pingcap/ticdc:v8.5.5
    docker save -o tiproxy-latest.tar pingcap/tiproxy:latest
    docker save -o tiflash-v8.5.5.tar pingcap/tiflash:v8.5.5
    docker save -o tidb-monitor-reloader-v1.0.1.tar pingcap/tidb-monitor-reloader:v1.0.1
    docker save -o tidb-monitor-initializer-v8.5.5.tar pingcap/tidb-monitor-initializer:v8.5.5
    ...
    ```shell
    docker load -i pd-v8.5.5.tar
    docker load -i tikv-v8.5.5.tar
    docker load -i tidb-v8.5.5.tar
    docker load -i ticdc-v8.5.5.tar
    docker load -i tiproxy-latest.tar
    docker load -i tiflash-v8.5.5.tar
    docker load -i tidb-monitor-reloader-v1.0.1.tar
    docker load -i tidb-monitor-initializer-v8.5.5.tar
