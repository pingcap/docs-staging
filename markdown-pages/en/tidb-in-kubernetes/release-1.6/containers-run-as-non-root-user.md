...
For the complete `ComponentSpec.securityContext` schema, refer to the [`ComponentSpec` API documentation](<https://github.com/pingcap/tidb-operator/blob/v1.6.6/docs/api-references/docs.md#componentspec>).
