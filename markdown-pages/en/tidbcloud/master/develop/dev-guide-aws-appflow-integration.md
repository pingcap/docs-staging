...
If you do not have a TiDB cluster, you can create a [TiDB Cloud Serverless](https://console.tidb.io/clusters) cluster, which is free and can be created in approximately 30 seconds.
...
- [TiDB Cloud Serverless](https://docs.tidb.io/tidbcloud/select-cluster-tier#tidb-cloud-serverless) is **NOT** a production environment.
