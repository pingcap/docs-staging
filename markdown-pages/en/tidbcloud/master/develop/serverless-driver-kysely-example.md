...
1. Create a table in your TiDB Cloud Starter instance and insert some data. 
...
On the overview page of your TiDB Cloud Starter instance, click **Connect** in the upper-right corner, and then get the connection string for your database from the displayed dialog. The connection string looks like this:
