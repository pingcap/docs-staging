...
1. If you do not have a TiDB Cloud account, click [here](https://tidbcloud.com/free-trial?provider_source=alicloud) to sign up for an account.

2. [Log in](https://tidbcloud.com/signup?provider_source=alicloud) to your TiDB Cloud account.
