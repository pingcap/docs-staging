...
Currently, SQL Editor is available only for [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) clusters hosted on AWS. To use SQL Editor, you need to [create a TiDB Cloud Starter cluster](/tidb-cloud/tidb-cloud-quickstart.md) hosted on AWS first.
