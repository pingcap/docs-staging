...
2. Use the [Export](/tidb-cloud/serverless-export.md) feature to export data from your TiDB Cloud Essential cluster, then use community tools such as [mydumper/myloader](https://centminmod.com/mydumper.html) to load the data into the MySQL service.
...
1. Navigate to the overview page of the target TiDB Cloud Essential cluster, and then click **Data** > **Changefeed** in the left navigation pane.
