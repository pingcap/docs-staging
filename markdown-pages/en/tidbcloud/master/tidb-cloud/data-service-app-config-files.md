...
|---------|---------|--------------|
| `cluster_id` | Integer | The ID of your TiDB Cloud Starter instance. You can get it from the URL of your instance. For example, if your instance URL is `https://tidbcloud.com/tidbs/1234567891234567890/overview?orgId=<organization-id>`, your instance ID is `1234567891234567890`. |
...
| `cluster_id`  | String | The ID of your TiDB Cloud Starter instance for your endpoint. You can get it from the URL of your instance. For example, if your instance URL is `https://tidbcloud.com/tidbs/1234567891234567890/overview?orgId=<organization-id>`, the instance ID is `1234567891234567890`. |
