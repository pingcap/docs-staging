...
TiDB Cloud changefeed helps you stream data from TiDB Cloud to other data services. Currently, TiDB Cloud Essential supports streaming data to Apache Kafka and MySQL.
...
>     4. Click **Submit**.
>
> - TiDB Cloud only allows up to 10 changefeeds per TiDB Cloud Essential instance.
...
2. Click the name of your target TiDB Cloud Essential instance to go to its overview page, and then click **Data** > **Changefeed** in the left navigation pane. The changefeed page is displayed.
...
1. Navigate to the [**Changefeed**](#view-the-changefeed-page) page of your target TiDB Cloud Essential instance.
...
For existing TiDB Cloud Essential instances created before July 1, 2026, changefeeds are free of charge.

Starting July 1, 2026, changefeeds are a billable feature for newly created TiDB Cloud Essential instances. For billing details, see [TiDB Cloud Essential Pricing Details](https://www.pingcap.com/tidb-cloud-essential-pricing-details/).
