...
> **Note:**
>
> - Currently, TiDB Cloud only allows up to 10 changefeeds per TiDB Cloud Essential cluster.
> - For [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) clusters, the changefeed feature is unavailable.
