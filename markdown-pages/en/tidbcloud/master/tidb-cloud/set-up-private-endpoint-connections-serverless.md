...
4. Take a note of **Service Name**, **Availability Zone ID**, and **Region ID**.
    ...
    > **Note:**
    >
    > You only need to create one private endpoint per AWS region, which can be shared by all TiDB Cloud Starter or TiDB Cloud Essential instances located in the same region.
...
After creating the AWS interface endpoint, you must add it to the allowlist of your target TiDB Cloud Starter or TiDB Cloud Essential instance.
