...
| Manage branches for TiDB Cloud Starter and TiDB Cloud Essential clusters in the project, such as branch creation, connection, and deletion. | ✅ | ❌ | ❌ | ❌ |
...
| View cluster data using [SQL Editor](/ai/explore-data-with-chat2query.md). | ✅ | ✅ | ✅ | ❌ |
| Modify and delete cluster data using [SQL Editor](/ai/explore-data-with-chat2query.md). | ✅ | ✅ | ❌ | ❌ |
