...
1. In the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), click the combo box in the upper-left corner. The list of organizations and projects you belong to is displayed.
