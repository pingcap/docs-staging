...
3. In the **AWS Private Endpoints for External Services** area, click **Create Private Endpoint for External Services**.
    ...
    > **Note:**
    >
    > - If your TiDB Cloud Essential instance is created on or after July 1, 2026, clicking **Create Private Endpoint for External Services** creates a private link connection in endpoint exclusive mode. In this mode, each TiDB Cloud Essential instance uses its own standalone private endpoint, which eliminates the need to include the [account prefix](/tidb-cloud/select-cluster-tier.md#user-name-prefix) when connecting.
    > - If your TiDB Cloud Essential instance is created before July 1, 2026, clicking **Create Private Endpoint for External Services** creates a private link connection in endpoint shared mode. In this mode, a single private endpoint can be shared by multiple TiDB Cloud Essential instances in the same AWS Region.
...
3. In the **Alibaba Cloud Private Endpoints for External Services** area, click **Create Private Endpoint for External Services**.
    ...
    >
    > - If your TiDB Cloud Essential instance is created on or after July 1, 2026, clicking **Create Private Endpoint for External Services** creates a private link connection in endpoint exclusive mode. In this mode, each TiDB Cloud Essential instance uses its own standalone private endpoint, which eliminates the need to include the [account prefix](/tidb-cloud/select-cluster-tier.md#user-name-prefix) when connecting.
    > - If your TiDB Cloud Essential instance is created before July 1, 2026, clicking **Create Private Endpoint for External Services** creates a private link connection in endpoint shared mode. In this mode, a single private endpoint can be shared by multiple TiDB Cloud Essential instances in the same Alibaba Cloud Region.
