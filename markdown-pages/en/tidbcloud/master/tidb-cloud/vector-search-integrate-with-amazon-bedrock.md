...
Get the TiDB connection information from the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud) and set the environment variables in your development environment as follows:
