...
This document describes how to connect a TiDB Cloud Essential instance to an [Alibaba Cloud ApsaraDB RDS for MySQL](https://www.alibabacloud.com/en/product/apsaradb-for-rds-mysql) instance using an [Alibaba Cloud Endpoint Service private link connection](/tidb-cloud/serverless-private-link-connection.md).
...
- Your TiDB Cloud Essential instance is on Alibaba Cloud, and it is active. Retrieve and save the following details for later use:
...
- Region match: the instance must reside in the same Alibaba Cloud region as your TiDB Cloud Essential instance.
- AZ (Availability Zone) availability: the availability zones must overlap with those of your TiDB Cloud Essential instance.
...
3. Go to [NLB](https://slb.console.alibabacloud.com/nlb) to create a network load balancer. Provide the following information:
    ...
    - **Zone**: it must overlap with your TiDB Cloud Essential instance
