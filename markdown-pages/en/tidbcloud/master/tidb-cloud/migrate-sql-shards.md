...
Create schemas in the <CustomContent plan="starter">TiDB Cloud Starter instance</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent><CustomContent plan="premium">TiDB Cloud Premium instance</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent> as follows:
...
1. Open the **Import** page for your target <CustomContent plan="starter">TiDB Cloud Starter instance</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent><CustomContent plan="premium">TiDB Cloud Premium instance</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent>.
    ...
    2. Click the name of your target <CustomContent plan="starter">TiDB Cloud Starter instance</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent><CustomContent plan="premium">TiDB Cloud Premium instance</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent> to go to its overview page, and then click **Data** > **Import** in the left navigation pane.
...
3. On the **Import Data from Amazon S3** page, fill in the following information:
    ...
    - **Import File Count**: for TiDB Cloud Starter or TiDB Cloud Essential, select **Multiple files**. This field is not available in TiDB Cloud Dedicated.
    ...
    If the location of the bucket is different from your <CustomContent plan="starter">TiDB Cloud Starter instance</CustomContent><CustomContent plan="essential">TiDB Cloud Essential instance</CustomContent><CustomContent plan="premium">TiDB Cloud Premium instance</CustomContent><CustomContent plan="dedicated">TiDB Cloud Dedicated cluster</CustomContent>, confirm the compliance of cross region.
