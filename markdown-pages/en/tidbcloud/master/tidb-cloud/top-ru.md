...
**Top RU** ranks SQL statements by their Request Unit (RU) consumption, helping you quickly identify which queries drive your RU usage. When you notice an unexpected RU spike in your TiDB Cloud Essential or TiDB Cloud Premium instance metrics, use Top RU to identify the responsible SQL statements and take targeted action.

> **Note:**
>
> - Top RU is available in public preview for TiDB Cloud Premium instances.
> - Top RU is available for TiDB Cloud Essential instances in selected regions during a phased rollout.

## Product plan comparison

Top RU capabilities vary by TiDB Cloud plan:

| Feature | TiDB Cloud Premium | TiDB Cloud Essential |
|---|---|---|
...
1. Log in to the [TiDB Cloud console](https://tidbcloud.com/) and navigate to your TiDB Cloud Essential or TiDB Cloud Premium instance.
...
- **Time range**: select a preset interval or a custom range.
    ...
    - The earliest available start date depends on your data retention: **30 days ago** for TiDB Cloud Premium instances, and **7 days ago** for TiDB Cloud Essential instances.
    - The maximum window for a single query is **24 hours**.

- **Top N**: select how many SQL statements to display.

    - TiDB Cloud Premium instance: **10** by default. Options: **5**, **20**, and **100**.
    - TiDB Cloud Essential instance: **10** by default. Options: **5** and **20**.
...
| Share | Percentage of total RU consumed by this SQL statement in the selected TiDB Cloud Essential or TiDB Cloud Premium instance. The top N SQL statements might not add up to 100%. Include the **Others** row to account for the remaining RU consumption and reach 100%. |
...
| Mean RU | Mean RU consumed by this SQL statement in the selected time range. This value equals total RU divided by executions. |
| Share | Percentage of total RU consumed by this SQL statement in the selected TiDB Cloud Essential or TiDB Cloud Premium instance. |
| Executions | Number of times this SQL statement was executed in the selected time range. |
| Plans | Number of execution plans for this SQL statement in the selected time range. |
| Total latency | Total execution time consumed by this SQL statement in the selected time range. |
| Mean latency | Mean execution time consumed by this SQL statement in the selected time range. This value equals total latency divided by executions. |
...
1. Notice an RU spike in your TiDB Cloud Essential or TiDB Cloud Premium instance metrics or a triggered alert.
...
Top RU ranks SQL statements by Request Unit (RU) consumption at the instance level and supports user-level breakdown. It applies to TiDB Cloud Premium instances and TiDB Cloud Essential instances.
...
- Check [TiDB Cloud Release Notes](/tidb-cloud/releases/tidb-cloud-release-notes.md) to confirm that Top RU is available for your TiDB Cloud Essential or TiDB Cloud Premium instance version and region.
