...
summary: Learn how to connect your TiDB Cloud Starter instance to AI-powered development tools that support the Model Context Protocol (MCP), such as Cursor, Claude Code, VS Code, and Windsurf.
---

# Use TiDB Cloud Starter with AI Tools

This document describes how to connect your TiDB Cloud Starter instance to AI-powered development tools that support the Model Context Protocol (MCP), such as Cursor, Claude Code, Visual Studio Code (VS Code), and Windsurf.

By configuring your TiDB Cloud Starter instance as an MCP server, you can enable AI assistants in your development tools to query your database schema, understand your data model, and generate context-aware code suggestions.
...
After you create a TiDB Cloud Starter instance in TiDB Cloud, perform the following steps to connect it to your AI tool.
