...
![Hybrid Search](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/hybrid-search-overview.svg)
...
You can get these connection parameters from the [TiDB Cloud console](https://console.tidb.io):
