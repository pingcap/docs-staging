...
You can use Key Visualizer to analyze the usage patterns of TiDB Cloud Dedicated clusters and troubleshoot traffic hotspots. This page provides a visual representation of the TiDB Cloud Dedicated cluster's traffic over time.
