...
List SQL users in a TiDB Cloud Starter or TiDB Cloud Essential instance:
...
List SQL users in a TiDB Cloud Starter or TiDB Cloud Essential instance in interactive mode:

```shell
ticloud serverless sql-user list
```

List SQL users in a TiDB Cloud Starter or TiDB Cloud Essential instance in non-interactive mode:
