...
Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance:
...
Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance in interactive mode:

```shell
ticloud serverless sql-user update
```

Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance in non-interactive mode:
