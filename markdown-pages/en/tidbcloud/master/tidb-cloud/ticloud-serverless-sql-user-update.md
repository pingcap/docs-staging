...
Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential cluster:
...
Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential cluster in interactive mode:

```shell
ticloud serverless sql-user update
```

Update a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential cluster in non-interactive mode:
