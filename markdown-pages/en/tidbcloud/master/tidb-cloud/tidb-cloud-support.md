...
You can access the PingCAP Help Center via <https://tidb.support.pingcap.com/servicedesk/customer/portals> directly, or through the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud) in the following ways:

- Click **?** in the lower-right corner of the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), and then click **Request Support**.
- Click **Support** in the lower-left corner of [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), and then click **Create Ticket**.
...
1. In the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), click **Support** in the lower-left corner.
