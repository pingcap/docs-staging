...
> **Note:**
>
> - [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#tidb-cloud-serverless) and [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) scale automatically based on your application's workload changes. However, you cannot manually scale a TiDB Cloud Starter or TiDB Cloud Essential cluster.
