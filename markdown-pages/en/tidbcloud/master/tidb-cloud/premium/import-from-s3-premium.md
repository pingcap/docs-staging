...
This document describes how to import CSV files from Amazon Simple Storage Service (Amazon S3) into TiDB Cloud Premium instances.
...
If you use an AWS Role ARN for a TiDB Cloud BYOC instance, the IAM role must have the `tidbcloud.com/allow-dataplane-access=true` tag. If the tag is missing, add it to the role before starting the import.

</CustomContent>

## Step 4. Import CSV files from Amazon S3

1. In the [TiDB Cloud console](https://tidbcloud.com/tidbs), navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, and then click the name of your TiDB Cloud Premium instance.
