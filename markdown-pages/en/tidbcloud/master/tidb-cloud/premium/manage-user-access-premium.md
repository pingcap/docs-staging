...
This document describes how to manage user access, roles, and permissions across organizations and TiDB Cloud Premium instances.
...
TiDB Cloud Premium uses a hierarchical structure of organizations and instances to help you manage users and TiDB Cloud Premium instances efficiently. As an `Organization Owner`, you can create and manage multiple instances within your organization.
...
- To access a TiDB Cloud Premium instance, users need at least read permissions for that instance in the organization.

For more information about user roles and permissions, see [User Roles](#user-roles).

### Organizations

An organization can include multiple TiDB Cloud Premium instances.
...
- Create TiDB Cloud Premium instances for different purposes.
...
If you are an `Instance Manager`, you can manage settings and operations for a specific TiDB Cloud Premium instance.

For example, you can do the following:

- Delete a TiDB Cloud Premium instance when it is no longer needed.
...
|---|---|---|---|---|---|
| Manage organization settings, such as TiDB Cloud Premium instances, API keys, and time zones. | ✅ | ❌ | ❌ | ❌ | ❌ |
| Add or remove organization members, and edit organization roles. | ✅ | ❌ | ❌ | ❌ | ❌ |
| `Instance Manager` permissions for all TiDB Cloud Premium instances in the organization. | ✅ | ❌ | ❌ | ❌ | ❌ |
...
> - If a member in your organization does not have any instance roles, the member cannot access any TiDB Cloud Premium instances in your organization.

| Permission  | `Instance Manager` | `Instance Viewer` |
|---|---|---|
| Manage instance settings | ✅ | ❌ |
| Manage [database audit logging](/tidb-cloud/tidb-cloud-auditing.md) of the TiDB Cloud Premium instances. | ✅ | ❌ |
| Manage instance operations, such as TiDB Cloud Premium instance creation, modification, and deletion. | ✅ | ❌ |
...
| Review and reset the root password for the TiDB Cloud Premium instance. | ✅ | ❌ |
| View the overview, backup records, metrics, events, and [changefeeds](/tidb-cloud/changefeed-overview.md) of the TiDB Cloud Premium instance. | ✅ | ✅ |
...
1. In the [TiDB Cloud console](https://tidbcloud.com), click the combo box in the upper-left corner. The list of organizations you belong to is displayed.
    ...
    > **Tip:**
    >
    > - If you are currently on the page of a specific TiDB Cloud Premium instance, after clicking the combo box in the upper-left corner, you also need to click **Back to My TiDB** in the combo box to return to the organization list.
...
> **Note:**
>
> You can also [invite a user to access or manage a TiDB Cloud Premium instance](#invite-a-user-to-access-or-manage-a-premium-instance) directly as needed, which also makes the user your organization member.
...
4. Enter the email address of the user to be invited, and then select an organization role for the user.
    ...
    > - The invited user does not have access to any TiDB Cloud Premium instances by default. To grant instance permissions to the user, see [Invite a user to access or manage a TiDB Cloud Premium instance](#invite-a-user-to-access-or-manage-a-premium-instance).
...
### Invite a user to access or manage a TiDB Cloud Premium instance {#invite-a-user-to-access-or-manage-a-premium-instance}

If you are in the `Organization Owner` role, you can invite users to access or manage your TiDB Cloud Premium instances.

> **Note:**
>
> When you invite a user not in your organization to access or manage your TiDB Cloud Premium instance, the user automatically joins your organization as well.

To invite a user to access or manage a TiDB Cloud Premium instance, take the following steps:
