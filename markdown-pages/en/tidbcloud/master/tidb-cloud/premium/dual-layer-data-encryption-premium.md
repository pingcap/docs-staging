...
summary: Learn how to enable and manage Dual-Layer Data Encryption for your TiDB Cloud Premium instance.
---

# Dual-Layer Data Encryption

This document describes how to enable and manage Dual-Layer Data Encryption for your TiDB Cloud Premium instance.
...
- Your cloud provider KMS key must reside in the same region as your TiDB Cloud Premium instance. As a result, cross-region restore operations are not supported for backups that use a CMEK.
...
1. Create a symmetric encryption key in your cloud provider KMS.
    ...
    The key must be in the **same region** as the planned TiDB Cloud Premium instance.
