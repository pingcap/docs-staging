...
- Set a password to access your instance in secure settings.
    ...
    To do so, you can navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, click **...** in the row of your TiDB Cloud Premium instance, and then select **Change Root Password**. In password settings, you can click **Auto-generate Password** to automatically generate a root password with a length of 16 characters, including numbers, uppercase and lowercase characters, and special characters.
...
1. Navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, and then click the name of your TiDB Cloud Premium instance to go to its overview page.
