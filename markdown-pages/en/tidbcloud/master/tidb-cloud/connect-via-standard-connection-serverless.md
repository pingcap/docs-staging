...
To connect to a TiDB Cloud Starter or TiDB Cloud Essential instance via public endpoint, take the following steps:
...
4. TiDB Cloud lets you create [branches](/tidb-cloud/branch-overview.md) for your TiDB Cloud Starter or TiDB Cloud Essential instance. After a branch is created, you can choose to connect to the branch via the **Branch** drop-down list. `main` represents the TiDB Cloud Starter or Essential instance itself.
