...
In the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), click **Support** in the lower-left corner. The **Support** page is displayed, with your current support plan highlighted with a **CURRENT** tag.
