...
- **Region and AZ**: Your Amazon MSK Provisioned cluster is in the same AWS region as your TiDB Cloud Essential cluster, and the availability zones of the MSK cluster are the same as your TiDB Cloud cluster.
