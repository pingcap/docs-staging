...
On the **Choose a Spec and Start Migration** page, select the migration specification. For more information about the specifications, see [Specifications for Data Migration](/tidb-cloud/tidb-cloud-billing-dm.md).
