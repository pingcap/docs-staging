...
- When [creating a branch](/tidb-cloud/branch-manage.md#create-a-branch) from a specific point in time:
    ...
    - For a free TiDB Cloud Starter cluster, you can select any time within the last 24 hours.
    - For a TiDB Cloud Starter (with spending limit > 0) or TiDB Cloud Essential cluster, you can select any time within the last 14 days.
