...
In the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud), you can get examples of different connection methods and connect to your TiDB Cloud cluster as follows:
