...
## Metrics for TiDB Cloud Starter and Essential clusters
...
| Average Query Duration | All, {SQL type} | The duration from receiving a request from the client to the TiDB Cloud Starter or TiDB Cloud Essential cluster until the cluster executes the request and returns the result to the client. |
