...
2. Click the name of the target TiDB Cloud Essential instance or TiDB Cloud Dedicated cluster to go to its overview page.
...
2. Click the name of the target TiDB Cloud Premium instance to go to its overview page.
3. Click **Alerts** in the left navigation pane.
4. The **Alerts** page displays the active alerts by default. You can view the information of each active alert such as the alert name, trigger time, and duration.
5. If you also want to view the closed alerts, just click the **Status** drop-down list and select **Closed** or **All**.
...
### Changefeed alerts for TiDB Cloud Dedicated
...
### Changefeed alerts for TiDB Cloud Essential and TiDB Cloud Premium
