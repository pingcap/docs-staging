...
- A [TiDB Cloud account](https://tidbcloud.com/signup) and a TiDB Cloud Starter instance on TiDB Cloud. For more details, see [TiDB Cloud Quick Start](https://docs.pingcap.com/tidbcloud/tidb-cloud-quickstart#step-1-create-a-starter-instance).
...
3. Set up action
    ...
    In this step, you need to specify a table in your TiDB Cloud Starter instance to store the event data. If you do not already have a table, you can create one through this step.

    1. From the drop-down list, choose the project name and instance name. The connection information of your TiDB Cloud Starter instance will be displayed automatically.

        ![Set up project name and instance name](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/zapier/zapier-set-up-tidbcloud-project-and-cluster.png)
    ...
    3. From the drop-down list, choose the database.
        ...
        Zapier queries the databases from TiDB Cloud using the password you entered. If no database is found in your TiDB Cloud Starter instance, re-enter your password and refresh the page.
...
4. Test action
    ...
    Click **Test action** to create a new row in the table. If you check your TiDB Cloud Starter instance, you can find the data is written successfully.
...
|---|---|---|
| Find Cluster | Finds an existing TiDB Cloud Starter instance or TiDB Cloud Dedicated cluster. | None |
| Create Cluster | Creates a new cluster. Only supports creating a TiDB Cloud Starter instance. | None |
| Find Database | Finds an existing database. | A TiDB Cloud Starter instance |
| Create Database | Creates a new database. | A TiDB Cloud Starter instance |
| Find Table | Finds an existing Table. | A TiDB Cloud Starter instance and a database |
| Create Table | Creates a new table. | A TiDB Cloud Starter instance and a database |
| Create Row | Creates a new row. | A TiDB Cloud Starter instance, a database, and a table |
| Update Row | Updates an existing row. | A TiDB Cloud Starter instance, a database, and a table |
| Find Row | Finds a row in a table via a lookup column. | A TiDB Cloud Starter instance, a database, and a table |
| Find Row (Custom Query) | Finds a row in a table via a custom query that you provide. | A TiDB Cloud Starter instance, a database, and a table |
