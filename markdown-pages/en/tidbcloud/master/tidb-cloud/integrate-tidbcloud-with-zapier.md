...
- A [TiDB Cloud account](https://tidbcloud.com/signup) and a TiDB Cloud Starter cluster on TiDB Cloud. For more details, see [TiDB Cloud Quick Start](https://docs.pingcap.com/tidbcloud/tidb-cloud-quickstart#step-1-create-a-tidb-cluster).
...
|---|---|---|
| Find Cluster | Finds an existing TiDB Cloud Starter or TiDB Cloud Dedicated cluster. | None |
