...
This document introduces how to build an auto-workflow: create a TiDB Cloud Starter instance, gather Hacker News RSS, store it to TiDB and send a briefing email.
...
### (Optional) Create a TiDB Cloud Starter instance

If you don't have a TiDB Cloud Starter instance, you can use this node to create one. Otherwise, feel free to skip this operation.
...
7. In the **Cluster Name** box, enter a name for the TiDB Cloud Starter instance.
8. In the **Region** list, select a region.
9. In the **Password** box, enter a password used to log in to your TiDB Cloud Starter instances.
10. Click **Execute Node** to run the node.

> **Note:**
>
> It takes several seconds to create a new TiDB Cloud Starter instance.
...
6. Select the TiDB Cloud Starter instance. If you have not seen your new instance in the list, you need to wait a few minutes until the instance creation is completed.
...
If the workflow runs as expected, you'll get Hacker News briefing emails. These news contents will be logged to your TiDB Cloud Starter instance, so you don't have to worry about losing them.
...
- **Create Serverless Cluster**: creates a TiDB Cloud Starter instance.
...
- **Cluster**: enter the name of your TiDB Cloud Starter instance.
- **Region**: the region name. Choose a region where your TiDB Cloud Starter instance will be deployed. Usually, choose the region closest to your application deployment.
- **Password**: the root password. Set a password for your new TiDB Cloud Starter instance.
...
- **Project**: the TiDB Cloud project name.
- **Operation**: the operation of this node. For all supported operations, refer to [Supported operations](#supported-operations).
- **Cluster**: the name of your TiDB Cloud Starter instance. You should choose one existing instance.
- **Password**: the password of your TiDB Cloud Starter instance.
- **User**: the username of your TiDB Cloud Starter instance.
...
- **Project**: the TiDB Cloud project name.
- **Operation**: the operation of this node. For all supported operations, refer to [Support Operation](#supported-operations).
- **Cluster**: the TiDB Cloud Starter instance name. You should choose one existing instance.
- **Password**: the password of your TiDB Cloud Starter instance.
- **User**: the username of your TiDB Cloud Starter instance.
- **Database**: the database name.
- **Table**: the table name. You can use the `From list` mode to choose one or use the `Name` mode to type the table name manually.
