...
A TiDB X instance is a service-oriented TiDB Cloud offering built on the [TiDB X architecture](/tidb-cloud/tidb-x-architecture.md), such as a TiDB Cloud Starter, Essential, or Premium instance.
...
> **Note:**
>
> This document applies only to TiDB Cloud Starter, Essential, and Premium. For TiDB Cloud Dedicated, see [Limited SQL Features on TiDB Cloud Dedicated](/tidb-cloud/limited-sql-features.md).
...
| `ALTER INSTANCE RELOAD TLS` | Not supported | TiDB Cloud Starter and TiDB Cloud Essential automatically refresh the TLS certificate. |
...
[^1]: Configuring data placement is not supported on TiDB Cloud Starter, Essential, or Premium.

[^2]: Configuring resource groups is not supported on TiDB Cloud Starter, Essential, or Premium.

[^3]: To perform [Back up and Restore](/tidb-cloud/backup-and-restore-serverless.md) operations on TiDB Cloud Starter, Essential, or Premium, you can use the TiDB Cloud console instead.

[^4]: The feature is unavailable in [Security Enhanced Mode (SEM)](/system-variables.md#tidb_enable_enhanced_security).

[^5]: To track [Slow Query](/tidb-cloud/tune-performance.md#slow-query) on TiDB Cloud Starter, Essential, or Premium, you can use the TiDB Cloud console instead.
...
[^8]: Plugins are not supported on TiDB Cloud Starter, Essential, or Premium.

[^9]: TiDB Cloud Starter and TiDB Cloud Essential enforce a strong password policy.
