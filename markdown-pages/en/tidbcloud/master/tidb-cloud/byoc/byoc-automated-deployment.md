...
After your TiDB Cloud BYOC region is fully operational, continue with [Create Your First TiDB Cloud BYOC Instance](/tidb-cloud/byoc/byoc-initialize-service.md) to create your first TiDB instance and configure secure administrative access.
