...
After deploying your BYOC infrastructure, create your first TiDB Cloud BYOC instance and configure secure administrative access.
...
After you create your first TiDB Cloud BYOC instance and configure secure administrative access, continue with [TiDB Cloud BYOC Joint Validation](/tidb-cloud/byoc/joint-validation.md) to validate connectivity, observability, security, and alerting.
