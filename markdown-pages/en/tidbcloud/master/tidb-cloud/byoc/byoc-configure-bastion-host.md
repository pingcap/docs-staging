---
title: Configure a Bastion Host for TiDB Cloud BYOC
summary: Learn how to deploy and manage bastion hosts for secure maintenance access in a TiDB Cloud BYOC environment.
---

# Configure a Bastion Host for TiDB Cloud BYOC

This document describes how to deploy and manage bastion hosts for a TiDB Cloud BYOC environment. Bastion hosts provide controlled access paths for secure interaction with the TiDB and observability EKS clusters in your AWS account.
...
- Your TiDB Cloud BYOC environment has been deployed.
- You have obtained the following information from TiDB Cloud Support:
    - Your TiDB Cloud tenant ID.
    - The AWS region ID where your TiDB Cloud BYOC environment is deployed.
...
5. In `terraform.tfvars`, configure the required fields:
    ...
    - `aws_region`: the AWS region where your TiDB Cloud BYOC environment is deployed, such as `us-west-2`.
