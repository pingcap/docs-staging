...
- You cannot use the Prometheus and Grafana integration in [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) or [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) clusters.
