...
Create a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance:
...
Create a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance in interactive mode:

```shell
ticloud serverless sql-user create
```

Create a SQL user in a TiDB Cloud Starter or TiDB Cloud Essential instance in non-interactive mode:
