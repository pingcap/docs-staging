...
This document describes how to log in to the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud) via basic Single Sign-on (SSO) authentication, which is quick and convenient.
