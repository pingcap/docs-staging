...
![s3_endpoint](https://download.pingcap.com/images/docs/tidb-cloud/changefeed/sink-to-cloud-storage-s3-endpoint.jpg)
...
1. In the TiDB Cloud console, record the **Service Account ID**, which will be used to grant TiDB Cloud access to your GCS bucket.
    ...
    ![gcs_endpoint](https://download.pingcap.com/images/docs/tidb-cloud/changefeed/sink-to-cloud-storage-gcs-endpoint.png)
