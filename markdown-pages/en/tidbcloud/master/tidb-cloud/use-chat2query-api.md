...
1. On the [**Data Service**](https://tidbcloud.com/project/data-service) page of your project, click <MDSvgIcon name="icon-create-data-app" /> **Create DataApp** in the left pane. The data app creation dialog is displayed.
    ...
    > **Tip:**
    >
    > If you are on the **SQL Editor** page of your TiDB Cloud Starter instance, you can also open the data app creation dialog by clicking **...** in the upper-right corner, choosing **Access Chat2Query via API**, and clicking **New Chat2Query Data App**.
...
- `cluster_id`: _string_. A unique identifier of the TiDB Cloud Starter instance.
