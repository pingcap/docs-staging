...
- A TiDB cluster. For more information, see [Create a TiDB Cloud Starter or Essential Cluster](/tidb-cloud/create-tidb-cluster-serverless.md) or [Create a TiDB Cloud Dedicated cluster](/tidb-cloud/create-tidb-cluster.md).
...
To execute the SQL statements, you can use [SQL Editor](/ai/explore-data-with-chat2query.md) in the [TiDB Cloud console](https://tidbcloud.com).
