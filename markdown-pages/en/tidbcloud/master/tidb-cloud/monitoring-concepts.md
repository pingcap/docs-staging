...
For more information, see [TiDB Cloud Premium Built-in Metrics](/tidb-cloud/premium/built-in-monitoring-premium.md).

</CustomContent>

## Built-in alerting

Built-in alerting refers to the alerting mechanism that TiDB Cloud provides to assist you in monitoring your TiDB Cloud Essential instances and TiDB Cloud Dedicated clusters. Currently, TiDB Cloud provides the following three types of alerts:
...
On the Alerts page of the TiDB Cloud console, you can view alerts of your TiDB Cloud Essential instance or TiDB Cloud Dedicated cluster, edit alert rules, and subscribe to alert notification emails.
...
- For TiDB Cloud Starter, Essential and Premium instances, TiDB Cloud logs the historical events at the instance level.
