...
This document describes how to manage branches of your TiDB Cloud Starter instance using the [TiDB Cloud console](https://tidbcloud.com). To manage branches using the TiDB Cloud CLI, see [`ticloud branch`](/tidb-cloud/ticloud-branch-create.md).
...
> **Note:**
>
> You can only create branches for TiDB Cloud Starter instances that are created after July 5, 2023. See [Limitations and quotas](/tidb-cloud/branch-overview.md#limitations-and-quotas) for more limitations.
...
4. In the **Create Branch** dialog, configure the following options:
    ...
    - **Parent branch**: select the original TiDB Cloud Starter instance or an existing branch. `main` represents the current instance.
...
Depending on the data size in your TiDB Cloud Starter instance, branch creation completes in a few minutes.

## View branches

To view branches for your TiDB Cloud Starter instance, perform the following steps:

1. In the [TiDB Cloud console](https://tidbcloud.com/), navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, and then click the name of your target TiDB Cloud Starter instance to go to its overview page.
2. Click **Branches** in the left navigation pane.

    The branch list of the TiDB Cloud Starter instance is displayed in the right pane.
...
Alternatively, you can get the connection string from the overview page of your TiDB Cloud Starter instance:
