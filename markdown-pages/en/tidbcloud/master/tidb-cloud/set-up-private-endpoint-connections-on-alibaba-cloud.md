...
summary: Learn how to connect to your TiDB Cloud Starter or Essential instance via Alibaba Cloud private endpoint.
---
...
> **Tip:**
>
> To learn how to connect to a TiDB Cloud Starter or Essential instance via AWS PrivateLink, see [Connect to TiDB Cloud via AWS PrivateLink](/tidb-cloud/set-up-private-endpoint-connections-serverless.md).
...
4. [Connect to your TiDB Cloud Starter or Essential instance using the private endpoint](#step-4-connect-to-your-instance-using-the-private-endpoint)
...
After creating the interface endpoint on Alibaba Cloud, you can authorize it for your target TiDB Cloud Starter or TiDB Cloud Essential instance to restrict access.
...
### Step 4. Connect to your TiDB Cloud Starter or Essential instance using the private endpoint {#step-4-connect-to-your-instance-using-the-private-endpoint}
