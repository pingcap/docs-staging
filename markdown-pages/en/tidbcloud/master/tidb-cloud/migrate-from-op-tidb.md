...
1. In the [TiDB Cloud console](https://tidbcloud.com/), get the Account ID and External ID of your target cluster according to the following documentation:
   ...
   - For TiDB Cloud Starter or TiDB Cloud Essential clusters, see [Configure Amazon S3 access using a Role ARN](/tidb-cloud/serverless-external-storage.md#configure-amazon-s3-access-using-a-role-arn).
...
6. Import data to TiDB Cloud.
    ...
    - For TiDB Cloud Starter or TiDB Cloud Essential clusters, see [Import CSV Files from Cloud Storage into TiDB Cloud Starter, Essential, or Premium](/tidb-cloud/import-csv-files-serverless.md).
