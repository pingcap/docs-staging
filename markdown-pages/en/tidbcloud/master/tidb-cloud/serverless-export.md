...
summary: Learn how to export data from TiDB Cloud Starter or TiDB Cloud Essential instances.
---

# Export Data from TiDB Cloud Starter or Essential

TiDB Cloud enables you to export data from a TiDB Cloud Starter or Essential instance to a local file or an external storage service. You can use the exported data for backup, migration, data analysis, or other purposes.

While you can also export data using tools such as [mysqldump](https://dev.mysql.com/doc/refman/8.0/en/mysqldump.html) and TiDB [Dumpling](https://docs.pingcap.com/tidb/dev/dumpling-overview), the export feature provided by TiDB Cloud offers a more convenient and efficient way to export data from a TiDB Cloud Starter or Essential instance. It brings the following benefits:

- Convenience: the export service provides a simple and easy-to-use way to export data from a TiDB Cloud Starter or Essential instance, eliminating the need for additional tools or resources.
...
To export data from a TiDB Cloud Starter instance to a local file, you need to export data [using the TiDB Cloud console](#export-data-to-a-local-file) or [using the TiDB Cloud CLI](/tidb-cloud/ticloud-serverless-export-create.md), and then download the exported data using the TiDB Cloud CLI.
...
- `Parquet`: export data in Parquet format. It is only applicable to TiDB Cloud Starter data exports.
...
2. Click the name of your target TiDB Cloud Starter instance to go to its overview page, and then click **Data** > **Import** in the left navigation pane.
...
3. On the **Import** page, click **Export Data to** in the upper-right corner, then choose **Local File** from the drop-down list. Fill in the following parameters:
   ...
   > **Tip:**
   >
   > If your TiDB Cloud Starter instance has neither imported nor exported any data before, you need to click **Click here to export data to...** at the bottom of the page to export data.
...
2. Click the name of your target TiDB Cloud Starter or Essential instance to go to its overview page, and then click **Data** > **Import** in the left navigation pane.
...
The export speed varies between TiDB Cloud Starter and TiDB Cloud Essential:
