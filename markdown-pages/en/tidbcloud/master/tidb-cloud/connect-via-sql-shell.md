...
> **Note:**
>
> You cannot connect to [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) or [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) using SQL Shell. To connect to your TiDB Cloud Starter or TiDB Cloud Essential instance, see [Connect to TiDB Cloud Starter or Essential Instance](/tidb-cloud/connect-to-tidb-cluster-serverless.md).
