...
1. In the [TiDB Cloud console](https://tidbcloud.com), go to the [**Data Service**](https://console.tidb.io/data-service) page of your project.
...
> **Note:**
>
> This method is only available for TiDB Cloud Serverless clusters.
