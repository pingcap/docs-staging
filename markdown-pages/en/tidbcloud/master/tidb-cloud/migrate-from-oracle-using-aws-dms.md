...
2. Set up the target [TiDB Cloud Starter](https://tidbcloud.com/clusters/create-cluster).
...
- [TiDB Cloud Account](https://tidbcloud.com/signup?provider_source=alicloud)
...
1. Log in to the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud).
