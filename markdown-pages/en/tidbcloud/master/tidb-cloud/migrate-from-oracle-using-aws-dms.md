...
2. Create a free Serverless Tier cluster.
    ...
    ![Create TiDB Cloud Serverless Tier](https://download.pingcap.com/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-4.png)

3. After the cluster is created, click **Security Settings** to set the user password.

    ![Set TiDB Cloud Serverless Tier Password](https://download.pingcap.com/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-5.png)

    ![Set TiDB Cloud Serverless Tier Password](https://download.pingcap.com/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-6.png)
...
5. Click the **Connect** button to connect your TiDB cluster:
    ...
    ![Connect to TiDB Cloud Serverless Tier](https://download.pingcap.com/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-7.png)
