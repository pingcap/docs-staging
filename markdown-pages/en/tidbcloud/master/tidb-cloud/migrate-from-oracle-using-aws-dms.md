...
This document describes a step-by-step example of how to migrate data from Amazon RDS for Oracle to [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) using AWS Database Migration Service (AWS DMS).
...
## Step 4. Create a TiDB Cloud Starter instance

1. Log in to the [TiDB Cloud console](https://tidbcloud.com/).

2. [Create a TiDB Cloud Starter instance](/tidb-cloud/tidb-cloud-quickstart.md).

3. In the [**My TiDB**](https://tidbcloud.com/tidbs) page, click the name of your target TiDB Cloud Starter instance to go to its overview page.
...
> **Note:**
>
> For detailed steps on creating an AWS DMS replication instance to work with TiDB Cloud Starter, see [Connect AWS DMS to TiDB Cloud](/tidb-cloud/tidb-cloud-connect-aws-dms.md).
...
> **Note:**
>
> For detailed steps on creating a TiDB Cloud Starter DMS endpoint, see [Connect AWS DMS to TiDB Cloud](/tidb-cloud/tidb-cloud-connect-aws-dms.md).
...
Connect to the [TiDB Cloud Starter instance](https://tidbcloud.com/tidbs) and check the `admin.github_event` table data. As shown in the following screenshot, DMS successfully migrated table `github_events` and 10000 rows of data.
