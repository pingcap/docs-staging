...
- For new TiDB Cloud Dedicated clusters, the default TiDB version is [v8.5.2](https://docs.pingcap.com/tidb/v8.5/release-8.5.2) starting from July 15, 2025.
- For TiDB Cloud Starter and TiDB Cloud Essential clusters, the TiDB version is [v7.5.2](https://docs.pingcap.com/tidb/v7.5/release-7.5.2) starting from April 22, 2025.
...
For a TiDB Cloud Starter, Essential, or Premium cluster, the steps to connect to your cluster are simplified as follows:
