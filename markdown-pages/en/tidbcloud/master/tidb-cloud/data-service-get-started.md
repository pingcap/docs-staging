...
Before creating a Data App, make sure that you have created a [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md) cluster hosted on AWS. If you do not have one, follow the steps in [Create a TiDB Cloud Starter, Essential, or Premium Cluster](/tidb-cloud/create-tidb-cluster-serverless.md) to create one.
