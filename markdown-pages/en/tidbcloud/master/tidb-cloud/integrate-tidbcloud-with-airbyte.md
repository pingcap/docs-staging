...
2. Fill in the following parameters.
    ...
    You can get the parameter values from the connection dialog of your cluster. To open the dialog, go to the [**Clusters**](https://console.tidb.io/project/clusters) page of your project, click the name of your target cluster to go to its overview page, and then click **Connect** in the upper-right corner.
...
3. Enable **SSL Connection**, and set TLS protocols to **TLSv1.2** or **TLSv1.3** in **JDBC URL Params**.
    ...
    > - TiDB Cloud Starter only supports TLS connections.
