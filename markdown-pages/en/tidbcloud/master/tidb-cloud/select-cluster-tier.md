...
The free plan is ideal for those who are getting started with TiDB Cloud Starter. It provides developers and small teams with the following essential features:
...
For each organization in TiDB Cloud, you can create a maximum of five free TiDB Cloud Starter instances by default. To create more TiDB Cloud Starter instances, you need to add a credit card and specify a spending limit.
