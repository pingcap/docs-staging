...
Alternatively, you can [create a TiDB Cloud Starter](/tidb-cloud/tidb-cloud-quickstart.md#step-1-create-a-starter-instance) to get familiar with TiDB Cloud for a quick evaluation. Note that the TiDB Cloud Starter has some [special terms and conditions](/tidb-cloud/serverless-limitations.md).
...
Because the amount of PoC credits is limited, to maximize the value of credits, it is recommended that you create a [TiDB Cloud Starter instance](/tidb-cloud/select-cluster-tier.md#starter) for compatibility tests and preliminary analysis on TiDB Cloud.
