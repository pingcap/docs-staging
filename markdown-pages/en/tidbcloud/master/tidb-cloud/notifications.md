...
| --- | --- | --- |
| TiDB Cloud Starter instance creation | A [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) instance is created. | All project members |
| TiDB Cloud Starter instance deletion | A TiDB Cloud Starter instance is deleted. | All project members |
| TiDB Cloud Essential instance creation | A [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) instance is created. | All project members |
| TiDB Cloud Essential instance deletion | A [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) instance is deleted. | All project members |
...
| Starter instance spending limit threshold alert | The [spending limit threshold](/tidb-cloud/manage-serverless-spend-limit.md) for TiDB Cloud Starter instances in the organization is reached. | `Organization Owner`, `Organization Billing Manager`, `Organization Billing Viewer`, and `Project Owner` |
