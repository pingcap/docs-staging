...
If you need to configure these external storages for TiDB Cloud Starter or TiDB Cloud Essential clusters, see [Configure External Storage Access for TiDB Cloud Starter, Essential, or Premium](/tidb-cloud/serverless-external-storage.md).
