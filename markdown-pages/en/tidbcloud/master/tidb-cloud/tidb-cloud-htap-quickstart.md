...
Before experiencing the HTAP feature, follow [TiDB Cloud Quick Start](/tidb-cloud/tidb-cloud-quickstart.md) to create a TiDB Cloud Starter cluster and import the **Steam Game Stats** sample dataset to the cluster.
