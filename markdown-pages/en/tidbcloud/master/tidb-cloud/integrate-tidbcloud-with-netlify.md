...
TiDB Cloud Starter and TiDB Cloud Essential clusters allow all IP addresses for connection by default, so you do not need to configure any traffic filter.
...
For a TiDB Cloud Starter or TiDB Cloud Essential cluster, you can get the connection string either from [TiDB Cloud CLI](/tidb-cloud/cli-reference.md) or from [TiDB Cloud console](https://tidbcloud.com/).
