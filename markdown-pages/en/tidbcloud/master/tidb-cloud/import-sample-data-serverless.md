---
title: Import Sample Data into TiDB Cloud Starter
summary: Learn how to import sample data into TiDB Cloud Starter via the UI.
---

# Import Sample Data into TiDB Cloud Starter
...
1. Open the **Import** page for your target cluster.
    ...
    1. Log in to the [TiDB Cloud console](https://tidbcloud.com/signup?provider_source=alicloud) and navigate to the [**Clusters**](https://tidbcloud.com/project/clusters) page of your project.
