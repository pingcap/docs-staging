...
- A [TiDB Cloud Starter or TiDB Cloud Essential instance](/tidb-cloud/create-tidb-cluster-serverless.md)
...
1. In the [TiDB Cloud console](https://tidbcloud.com/), navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, and then click the name of your target TiDB Cloud Starter or TiDB Cloud Essential instance to go to its overview page.
...
6. Click **Connect** to connect between your TiDB Cloud Starter or Essential instance and your GitHub repository.
...
One of the best practices for using branches is to create a branching CI workflow. With the workflow, you can test your code using a branch of your TiDB Cloud Starter or Essential instance instead of using the production instance itself before merging the pull request. You can find a live demo [here](https://github.com/shiyuhang0/tidbcloud-branch-gorm-example).
