...
![Sysbench point select performance](https://download.pingcap.com/images/docs/tidb-cloud/v6.5.6-oltp_select_point.png)
...
![Sysbench read write performance](https://download.pingcap.com/images/docs/tidb-cloud/v6.5.6-oltp_read_write.png)
...
![Sysbench update non-index performance](https://download.pingcap.com/images/docs/tidb-cloud/v6.5.6-oltp_update_non_index.png)
...
![Sysbench update index performance](https://download.pingcap.com/images/docs/tidb-cloud/v6.5.6-oltp_update_index.png)
...
![Sysbench insert performance](https://download.pingcap.com/images/docs/tidb-cloud/v6.5.6-oltp_insert.png)
