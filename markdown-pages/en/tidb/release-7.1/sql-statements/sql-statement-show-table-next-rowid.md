...
* [`_tidb_rowid`](https://docs.pingcap.com/tidb/v7.1/tidb-rowid/), the hidden row ID column automatically managed by TiDB for supported tables.
...
* [_tidb_rowid](https://docs.pingcap.com/tidb/v7.1/tidb-rowid/)
