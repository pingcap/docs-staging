...
- The system variable [`tidb_opt_enable_hash_join`](/system-variables.md#tidb_opt_enable_hash_join-new-in-v656) is set to `OFF`, and all other join types are also excluded.
