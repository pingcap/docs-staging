...
* [`_tidb_rowid`](https://docs.pingcap.com/tidb/v6.5/tidb-rowid/), the hidden row ID column automatically managed by TiDB for supported tables.
...
* [_tidb_rowid](https://docs.pingcap.com/tidb/v6.5/tidb-rowid/)
