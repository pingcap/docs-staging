...
> **Note:**
>
> `{version}` indicates the version number of TiDB. For example, if `{version}` is `v6.1.4`, the package download link is `https://download.pingcap.org/tidb-community-server-v6.1.4-linux-amd64.tar.gz`.
