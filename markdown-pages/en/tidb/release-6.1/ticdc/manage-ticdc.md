...
| `protocol` | The protocol with which messages are output to Pulsar. The value options are `canal-json`, `open-protocol`, and `avro`. |
...
# Currently the following protocols are supported: canal-json, open-protocol, and avro.
# protocol = "canal-json"
```
