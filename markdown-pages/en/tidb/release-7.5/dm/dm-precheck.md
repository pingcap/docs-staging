...
* (Mandatory) Consistency of upstream MySQL multi-instance sharding tables
    ...
    - In the optimistic mode, check whether the schemas of all sharded tables meet the [optimistic compatibility](https://github.com/pingcap/tiflow/blob/release-7.5/dm/docs/RFCS/20191209_optimistic_ddl.md#modifying-column-types).
