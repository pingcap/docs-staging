...
> **Note:**
>
> This variable is read-only for [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter).
...
- This variable returns the MySQL version, followed by the TiDB version. For example '8.0.11-TiDB-v7.5.7'.
