...
> **Note:**
>
> `{version}` in the link indicates the version number of TiDB. For example, the download link for `v7.5.2` in the `amd64` architecture is `https://download.pingcap.org/tidb-community-server-v7.5.2-linux-amd64.tar.gz`.
