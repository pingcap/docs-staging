...
- Determines whether to clone a specific version of a package
    ...
    - Execute the `tiup mirror clone <target-dir> --tidb v7.5.8` command to clone the v7.5.8 version of the TiDB component.
    - Run the `tiup mirror clone <target-dir> --tidb v7.5.8 --tikv all` command to clone the v7.5.8 version of the TiDB component and all versions of the TiKV component.
    - Run the `tiup mirror clone <target-dir> v7.5.8` command to clone the v7.5.8 version of all components in a cluster.
