...
* [DBeaver](https://dbeaver.io/) v23.0.1 supports TiDB by default [#17396](https://github.com/dbeaver/dbeaver/issues/17396) @[Icemap](https://github.com/Icemap)
    ...
    - The default configuration supports [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter), making it easier to connect to TiDB Cloud Starter.
