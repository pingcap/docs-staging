...
> **Note:**
>
> If your cluster does not contain **TiFlash** nodes, this SQL statement will report an error: `1105 - the tiflash replica count: 1 should be less than the total tiflash server count: 0`. You can use [Create a TiDB Cloud Starter Instance](/develop/dev-guide-build-cluster-in-cloud.md#step-1-create-a-starter-instance) to create a TiDB Cloud Starter instance that includes **TiFlash**.
