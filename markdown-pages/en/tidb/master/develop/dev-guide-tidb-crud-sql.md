...
Please make sure you are connected to TiDB. If not, [Create a TiDB Cloud Starter Instance](/develop/dev-guide-build-cluster-in-cloud.md#step-1-create-a-starter-instance) and connect to it first.
...
To experiment with SQL and test out TiDB compatibility with MySQL queries, you can try [TiDB Playground](https://play.tidbcloud.com/?utm_source=docs&utm_medium=basic-sql-operations). You can also first [Create a TiDB Cloud Starter Instance](/develop/dev-guide-build-cluster-in-cloud.md#step-1-create-a-starter-instance) and then run SQL statements in it.
