...
TiDB uses the [`performance_schema_session_connect_attrs_size`](/system-variables.md#performance_schema_session_connect_attrs_size-new-in-v857-and-v900) global system variable to control the maximum total size of connection attributes per session.
