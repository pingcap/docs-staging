...
To complete this tutorial, make sure you have a TiDB Cloud Starter instance in a supported region. If you don't have one, follow [Creating a TiDB Cloud Starter instance](/develop/dev-guide-build-cluster-in-cloud.md) to create it.
