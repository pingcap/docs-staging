...
- **A TiDB Cloud Starter instance**: You can create a free TiDB Cloud Starter instance on [TiDB Cloud](https://tidbcloud.com/free-trial).
...
2. In the TiDB Cloud console, navigate to the [**My TiDB**](https://tidbcloud.com/tidbs) page, and then click the name of your target TiDB Cloud Starter instance to go to its overview page.
...
- `show_databases` - Show all databases in the TiDB Cloud Starter instance
