...
For a TiDB Cloud Starter or Essential instance, take the following steps to obtain the connection string and configure environment variables:
...
5. In the root directory of your Python project, create a `.env` file and paste the connection parameters to the corresponding environment variables.
    ...
    - `TIDB_HOST`: The host of the TiDB Cloud Starter or Essential instance.
    - `TIDB_PORT`: The port of the TiDB Cloud Starter or Essential instance.
