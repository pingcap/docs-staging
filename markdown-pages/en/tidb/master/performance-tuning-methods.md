...
![TPC-C](https://download.pingcap.com/images/docs/performance/tpcc_cpu_memory.png)
...
![TPC-C](https://download.pingcap.com/images/docs/performance/tpcc_read_write_traffic.png)
...
- Write traffic before Titan is enabled
    ...
    ![Titan Disable](https://download.pingcap.com/images/docs/performance/titan_disable.png)
...
- Write traffic after Titan is enabled
    ...
    ![Titan Enable](https://download.pingcap.com/images/docs/performance/titan_enable.png)
