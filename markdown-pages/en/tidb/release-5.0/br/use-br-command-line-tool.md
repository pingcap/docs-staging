...
> **Warning:**
>
> Although you can back up and restore system tables (such as `mysql.tidb`) using the BR tool, some unexpected situations might occur after the restoration, including:
>
...
>
> Restoring system tables might cause more compatibility issues. To avoid unexpected problems, **DO NOT** restore system tables in the production environment.
