...
![2-DC in 2 Cities Deployment Architecture](https://download.pingcap.com/images/docs/deploy-2city3dc.png)
...
![Data Replication in 2-DC in 2 Cities Deployment](https://download.pingcap.com/images/docs/deploy-binlog.png)
...
![2-DC as a Mutual Backup Deployment](https://download.pingcap.com/images/docs/deploy-backup.png)
