...
aliases: ['/docs/v2.1/geo-redundancy-deployment/','/docs/v2.1/how-to/deploy/geographic-redundancy/overview/']
---
...
![2-DC in 2 Cities Deployment Architecture](https://docs-download.pingcap.com/media/images/docs/deploy-2city3dc.png)
...
![Data Replication in 2-DC in 2 Cities Deployment](https://docs-download.pingcap.com/media/images/docs/deploy-binlog.png)
...
![2-DC as a Mutual Backup Deployment](https://docs-download.pingcap.com/media/images/docs/deploy-backup.png)
