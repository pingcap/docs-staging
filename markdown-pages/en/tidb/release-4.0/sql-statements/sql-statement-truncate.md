...
aliases: ['/docs/stable/sql-statements/sql-statement-truncate/','/docs/v4.0/sql-statements/sql-statement-truncate/','/docs/stable/reference/sql/statements/truncate/']
---
