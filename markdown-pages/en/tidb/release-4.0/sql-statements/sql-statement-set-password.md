...
aliases: ['/docs/stable/sql-statements/sql-statement-set-password/','/docs/v4.0/sql-statements/sql-statement-set-password/','/docs/stable/reference/sql/statements/set-password/']
---
