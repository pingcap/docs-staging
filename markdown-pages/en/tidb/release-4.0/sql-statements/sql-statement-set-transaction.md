...
aliases: ['/docs/stable/sql-statements/sql-statement-set-transaction/','/docs/v4.0/sql-statements/sql-statement-set-transaction/','/docs/stable/reference/sql/statements/set-transaction/']
---
