...
aliases: ['/docs/stable/sql-statements/sql-statement-show-processlist/','/docs/v4.0/sql-statements/sql-statement-show-processlist/','/docs/stable/reference/sql/statements/show-processlist/']
---
