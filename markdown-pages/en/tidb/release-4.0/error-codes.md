...
aliases: ['/docs/stable/error-codes/','/docs/v4.0/error-codes/','/docs/stable/reference/error-codes/','/docs/v4.0/reference/error-codes/']
---
...
* Error Number: 8025
    ...
    If a pair exceeds this limit, you need to properly adjust the [`txn-entry-size-limit`](/tidb-configuration-file.md#txn-entry-size-limit-new-in-v4010) configuration value to relax the limit.
