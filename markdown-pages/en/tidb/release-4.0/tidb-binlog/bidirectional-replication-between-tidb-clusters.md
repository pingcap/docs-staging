...
aliases: ['/docs/stable/tidb-binlog/bidirectional-replication-between-tidb-clusters/','/docs/v4.0/tidb-binlog/bidirectional-replication-between-tidb-clusters/','/docs/stable/reference/tidb-binlog/bidirectional-replication/','/docs/v4.0/reference/tidb-binlog/bidirectional-replication/']
---
