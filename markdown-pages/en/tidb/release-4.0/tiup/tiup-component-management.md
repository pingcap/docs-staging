...
aliases: ['/tidb/v4.0/manage-tiup-component','/docs/stable/tiup/manage-tiup-component/','/docs/v4.0/tiup/manage-tiup-component/','/docs/stable/reference/tools/tiup/manage-component/']
---
