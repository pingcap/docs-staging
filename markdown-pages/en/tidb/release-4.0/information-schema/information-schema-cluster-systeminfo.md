...
aliases: ['/docs/stable/system-tables/system-table-cluster-systeminfo/','/docs/v4.0/system-tables/system-table-cluster-systeminfo/','/docs/stable/reference/system-databases/cluster-systeminfo/','/tidb/stable/system-table-cluster-systeminfo/','/tidb/v4.0/system-table-cluster-systeminfo/']
---
