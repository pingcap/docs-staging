...
aliases: ['/docs/stable/tidb-lightning/tidb-lightning-web-interface/','/docs/v4.0/tidb-lightning/tidb-lightning-web-interface/','/docs/stable/reference/tools/tidb-lightning/web/']
---
