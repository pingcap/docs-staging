...
List all branches for a TiDB Cloud Starter or TiDB Cloud Essential cluster:
...
List all branches for a TiDB Cloud Starter or TiDB Cloud Essential cluster in interactive mode:

```shell
ticloud serverless branch list
```

List all branches for a specific TiDB Cloud Starter or TiDB Cloud Essential cluster in non-interactive mode:

```shell
ticloud serverless branch list -c <cluster-id>
```

List all branches for a specific TiDB Cloud Starter or TiDB Cloud Essential cluster in the JSON format:
