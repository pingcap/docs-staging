...
![Sysbench point select performance](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/v8.5.0_oltp_point_select.png)
...
![Sysbench read write performance](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/v8.5.0_oltp_read_write.png)
...
![Sysbench update non-index performance](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/v8.5.0_oltp_update_non_index.png)
...
![Sysbench update index performance](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/v8.5.0_oltp_update_index.png)
...
![Sysbench insert performance](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/v8.5.0_oltp_insert.png)
