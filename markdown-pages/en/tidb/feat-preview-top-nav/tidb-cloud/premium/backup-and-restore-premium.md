...
2. On the **Select Backup** page, select the project that contains the target TiDB Cloud Dedicated cluster. Select the cluster, select the backup snapshot that you want to restore, and then click **Next**.
...
Currently, manual backups are not supported for TiDB Cloud Premium instances.
