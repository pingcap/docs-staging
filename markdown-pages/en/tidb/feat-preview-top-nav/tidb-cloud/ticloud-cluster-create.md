...
| --encryption                 | Enables dual-layer data encryption. It is enabled by default for TiDB Cloud Essential clusters, and disabled by default for TiDB Cloud Starter clusters.                       | No       | Only works in non-interactive mode.                 |
