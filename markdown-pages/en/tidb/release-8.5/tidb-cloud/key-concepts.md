...
- For <CustomContent plan="starter,essential">TiDB Cloud Starter and TiDB Cloud Essential</CustomContent> <CustomContent plan="premium">TiDB Cloud Starter, TiDB Cloud Essential, and TiDB Cloud Premium</CustomContent>, see [High Availability in TiDB Cloud](/tidb-cloud/serverless-high-availability.md).
