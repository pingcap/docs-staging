...
> **Note:**
>
> The **Starter Spending Limit** budget cannot be edited because it is automatically created by TiDB Cloud to help you track the cost of a TiDB Cloud Starter cluster against its [spending limit](/tidb-cloud/manage-serverless-spend-limit.md).
...
> - The **Starter Spending Limit** budget cannot be deleted because it is automatically created by TiDB Cloud to help you track the cost of a TiDB Cloud Starter cluster against its [spending limit](/tidb-cloud/manage-serverless-spend-limit.md).
