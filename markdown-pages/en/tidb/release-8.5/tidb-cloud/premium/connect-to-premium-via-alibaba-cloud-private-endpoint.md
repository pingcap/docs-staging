...
summary: Learn how to connect to your TiDB Cloud Premium instance via a private endpoint on Alibaba Cloud.
---

# Connect to TiDB Cloud Premium via Alibaba Cloud Private Endpoint

This document describes how to connect to your TiDB Cloud Premium instance via a private endpoint on Alibaba Cloud. Connecting through a private endpoint enables secure and private communication between your services and your TiDB instance without using the public internet.

> **Tip:**
>
> To learn how to connect to a TiDB Cloud Premium instance via AWS PrivateLink, see [Connect to TiDB Cloud Premium via AWS PrivateLink](/tidb-cloud/premium/connect-to-premium-via-aws-private-endpoint.md).
...
1. On the [**TiDB Instances**](https://tidbcloud.com/instances) page, click the name of your target TiDB instance to go to its overview page.
