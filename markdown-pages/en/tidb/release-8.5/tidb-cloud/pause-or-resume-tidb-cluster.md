...
> **Note:**
>
> You cannot pause a [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) or [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) cluster.
