...
TiDB Lake provides a JDBC driver named [Metabase TiDB Lake Driver](https://github.com/databendcloud/metabase-databend-driver/releases/latest), enabling you to connect to Metabase and dashboard your data in TiDB Lake / TiDB Cloud Lake. For more information about the Metabase TiDB Lake Driver, refer to <https://github.com/databendcloud/metabase-databend-driver>

## Downloading & Installing Metabase TiDB Lake Driver

To download and install the Metabase TiDB Lake Driver:
...
2. [Download](https://github.com/databendcloud/metabase-databend-driver/releases/latest) the Metabase TiDB Lake Driver, then save it in the **plugins** folder.
...
This tutorial guides you through the process of integrating TiDB Lake / TiDB Cloud Lake with Metabase using the Metabase TiDB Lake Driver.
...
For this tutorial, you can integrate either with TiDB Lake or TiDB Cloud Lake:

- If you choose to integrate with a local TiDB Lake instance, deploy it if you don't have one already.
...
3. [Download](https://github.com/databendcloud/metabase-databend-driver/releases/latest) the Metabase TiDB Lake Driver, then import it to the **plugins** folder of the Metabase container in Docker.
...
2. Complete the initial sign-up process. Select **I'll add my data later** in step 3.
    ...
    ![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/add-later.png)

3. Click on the **gear** icon in the top right, and navigate to **Admin settings** > **Databases** > **Add a database** to create a connection:

    | Parameter                     | TiDB Lake               | TiDB Cloud Lake                     |
    | ----------------------------- | ---------------------- | ---------------------------------- |
