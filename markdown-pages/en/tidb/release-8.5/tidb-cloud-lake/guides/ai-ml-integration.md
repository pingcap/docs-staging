...
summary: "TiDB Lake enables powerful AI and ML capabilities through two complementary approaches build custom AI functions with your own infrastructure, or create conversational data experiences using natural language."
---

# AI & ML Integration

TiDB Lake enables powerful AI and ML capabilities through two complementary approaches: build custom AI functions with your own infrastructure, or create conversational data experiences using natural language.
...
The Model Context Protocol (MCP) server enables AI assistants to interact with your TiDB Lake database using natural language, perfect for building conversational BI tools.
...
**[MCP Client Integration](/tidb-cloud-lake/guides/mcp-client-integration.md)** - Configure generic MCP clients (like Codex) to connect to TiDB Lake
