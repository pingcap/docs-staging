---
title: Editions
summary: "TiDB Cloud Lake comes in three editions Personal, Business, and Dedicated, that you can choose from to serve a wide range of needs and ensure optimal performance for different use cases."
---
...
| TiDB Cloud Lake Connector for Kafka for loading data from Apache Kafka topics. | ✓ | ✓ | ✓ |
