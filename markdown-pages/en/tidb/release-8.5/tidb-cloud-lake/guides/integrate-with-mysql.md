---
title: MySQL
summary: The MySQL data integration enables you to sync data from MySQL databases into TiDB Cloud Lake in real-time, with support for full snapshot loads, continuous Change Data Capture (CDC), or a combination of both.
---

# MySQL

The MySQL data integration enables you to sync data from MySQL databases into TiDB Cloud Lake in real-time, with support for full snapshot loads, continuous Change Data Capture (CDC), or a combination of both.
...
| **Target Database** | Choose the target database in TiDB Cloud Lake                             |
| **Target Table**    | The table name in TiDB Cloud Lake (defaults to the source table name)     |
...
3. Writes changes to a raw staging table in TiDB Cloud Lake
