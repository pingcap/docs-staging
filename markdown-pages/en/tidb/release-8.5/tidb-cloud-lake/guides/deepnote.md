...
Both TiDB Lake and TiDB Cloud Lake support integration with Deepnote, requiring a secure connection. When integrating with TiDB Lake, please note that the default port is `8124`.
