...
Schema evolution allows TiDB Cloud Lake to automatically add new columns to a table during `COPY INTO` when the source Parquet files contain columns not yet present in the table.
