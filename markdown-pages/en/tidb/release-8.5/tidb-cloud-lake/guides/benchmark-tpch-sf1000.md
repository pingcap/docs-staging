---
title: "TPC-H SF1000 (1TB): TiDB Cloud Lake Warehouse Size Benchmark"
summary: This guide presents a performance comparison of Small, Medium, and Large TiDB Cloud Lake Warehouses using the TPC-H SF1000 dataset. It includes query execution times for each warehouse size and instructions to reproduce the benchmark results.
---

# TPC-H SF1000 (1TB): TiDB Cloud Lake Warehouse Size Benchmark

This page compares Small, Medium, and Large TiDB Cloud Lake Warehouses on the same TPC-H SF1000 workload. SF1000 is commonly used to represent about 1TB of TPC-H data.
...
![TPC-H SF1000 Warehouse Size Benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/tpch-sf1000-warehouse-size-benchmark.png)
