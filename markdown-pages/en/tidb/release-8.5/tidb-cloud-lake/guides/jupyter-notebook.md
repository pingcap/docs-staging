...
[Jupyter Notebook](https://jupyter.org/) is an interactive environment for running code, querying data, and creating visualizations. You can connect a notebook to TiDB Cloud Lake through the [TiDB Cloud Lake dialect for SQLAlchemy](https://github.com/tidbcloud/lake-sqlalchemy).
