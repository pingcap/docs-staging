...
summary: The Data Integration feature in TiDB Cloud Lake provides a visual, no-code interface for importing or synchronizing data from external systems into TiDB Cloud Lake.
---

# Data Integration Overview

The Data Integration feature in TiDB Cloud Lake provides a visual, no-code interface for importing or synchronizing data from external systems into TiDB Cloud Lake. The feature centers around two key concepts: **data sources** and **integration tasks**.
...
| [Integration Tasks](/tidb-cloud-lake/guides/integration-tasks.md) | Executable tasks that define where data comes from, which TiDB Cloud Lake table it is written to, which runtime parameters are used, and how the task is started and monitored. |
...
> **Note:**
>
> Running Data Integration tasks incurs service hosting fees. TiDB Cloud Lake bills these fees per second based on the actual running time of the service. For details, see [Service Hosting Pricing](/tidb-cloud-lake/guides/pricing-billing.md#service-hosting-pricing).
...
| [Amazon SQS (S3) (Beta)](/tidb-cloud-lake/guides/integrate-with-amazon-sqs-s3.md) | Consumes S3 object creation events from an SQS queue and writes the corresponding object data into TiDB Cloud Lake. |
