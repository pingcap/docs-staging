...
TiDB Cloud Lake currently supports two types of data sources:
...
![Task List](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dataintegration-task-list-with-action-button.png)
...
![Run History](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dataintegration-run-history-page.png)
