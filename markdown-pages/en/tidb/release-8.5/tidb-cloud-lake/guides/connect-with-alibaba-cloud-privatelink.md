...
1. Get the endpoint service name from the **Connect to TiDB Cloud Lake** dialog.
...
2. Prepare a security group that allows inbound TCP traffic on port 443.
    ...
    ![Security group allowing HTTPS traffic](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/alibaba-privatelink-security-group.png)
...
3. In the [Alibaba Cloud VPC console](https://vpc.console.aliyun.com/endpoint/ap-northeast-1/endpoints/new), create an endpoint. This example uses Japan (Tokyo).
    ...
    ![Create an endpoint with the Lake endpoint service name](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/alibaba-privatelink-create-endpoint.png)
...
4. On the endpoint details page, enable **Custom Domain Name**.
    ...
    ![Enable the custom domain name](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/alibaba-privatelink-custom-domain-name.png)
...
5. Verify the endpoint connection from an Elastic Compute Service (ECS) instance in your VPC.
    ...
    1. On the TiDB Cloud Lake home page, click **Connect**. In the **Connect to TiDB Cloud** dialog, copy the **Host** value under **Connection Information**.
        ...
        ![Copy the TiDB Cloud Lake host from the connection information](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/alibaba-privatelink-connection-host.png)
