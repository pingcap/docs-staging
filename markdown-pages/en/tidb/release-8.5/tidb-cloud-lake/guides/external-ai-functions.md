...
summary: Build powerful AI/ML capabilities by connecting TiDB Lake with your own infrastructure. External functions let you deploy custom models, leverage GPU acceleration, and integrate with any ML framework while keeping your data secure.
---

# External AI Functions

Build powerful AI/ML capabilities by connecting TiDB Lake with your own infrastructure. External functions let you deploy custom models, leverage GPU acceleration, and integrate with any ML framework while keeping your data secure.
...
2. **Register Function**: Connect your server to TiDB Lake with `CREATE FUNCTION`
