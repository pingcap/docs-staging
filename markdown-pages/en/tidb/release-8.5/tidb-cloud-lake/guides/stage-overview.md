...
Utilizing a stage for loading data also improves the efficiency of uploading, managing, and filtering your data files. With [LakeSQL](/tidb-cloud-lake/guides/connect-using-lakesql.md), you can easily upload or download files to or from a stage using a single command. When loading data into TiDB Cloud Lake, you can directly specify a stage in the COPY INTO command, allowing the command to read and even filter data files from that stage. Similarly, when exporting data from TiDB Cloud Lake, you can dump your data files into a stage.
