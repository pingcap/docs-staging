---
title: "TPC-H Benchmark: TiDB Cloud Lake vs. Snowflake"
summary: This guide presents a performance and cost comparison between TiDB Cloud Lake and Snowflake using the TPC-H SF100 dataset. It includes data loading and query execution benchmarks, along with instructions to reproduce the results.
---
...
- **[TiDB Cloud Lake](https://www.tidbcloud.com)**: TiDB Cloud Lake offers similar functionalities to Snowflake, being a cloud-native data warehouse that also separates storage from computing and provides scalable computing as needed.
...
> **Note:**
>
> This benchmark uses default settings for both Snowflake and TiDB Cloud Lake without any special tuning. This comparison is based on Snowflake Gen1 standard warehouses (`GENERATION = '1'`). And remember, **don't just take our word for it — you're encouraged to run and verify these results yourself.**

### Data Loading Benchmark

![TPC-H SF100 data loading benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/tpch-sf100-data-loading-benchmark.png)

| Table            | Snowflake (695s, Cost $0.77) | TiDB Cloud Lake (446s, Cost $0.40) | Rows        |
| ---------------- | --------------------------- | -------------------------------- | ----------- |
...
![TPC-H SF100 Cold Run Benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/tpch-sf100-cold-run-benchmark.png)

| Query          | Snowflake (Total 207s, Cost $0.23) | TiDB Cloud Lake (Total 166s, Cost $0.15) |
| -------------- | --------------------------------- | -------------------------------------- |
...
![TPC-H SF100 Hot Run Benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/tpch-sf100-hot-run-benchmark.png)

| Query          | Snowflake (Total 138s, Cost $0.15) | TiDB Cloud Lake (Total 124s, Cost $0.11) |
| -------------- | ---------------------------------- | --------------------------------------- |
| TPC-H 1        | 8.934                              | 7.568                                   |
| TPC-H 2        | 3.018                              | 3.125                                   |
| TPC-H 3        | 6.089                              | 5.234                                   |
...
| Parameter      | Snowflake                                                | TiDB Cloud Lake                            |
| -------------- | -------------------------------------------------------- | ----------------------------------------- |
...
- The TPC-H SF100 dataset, sourced from [Amazon Redshift](https://github.com/awslabs/amazon-redshift-utils/tree/master/src/CloudDataWarehouseBenchmark/Cloud-DWB-Derived-from-TPCH), was loaded into both TiDB Cloud Lake and Snowflake without any specific tuning.
...
- Create a [TiDB Cloud Lake account](https://tidbcloud.com)
...
2. **TiDB Cloud Lake Data Load**:
    ...
    - Sign in to your [TiDB Cloud Lake account](https://tidbcloud.com).
