...
- TiDB Cloud Lake access with connection information for a warehouse (see [Connecting to a Warehouse](/tidb-cloud-lake/guides/warehouse.md#connecting-to-a-warehouse))
...
3. Input the `DSN` field for your TiDB Cloud Lake instance. For example:
    ...
    TiDB Cloud Lake: `lake://cloudapp:******@tnxxxxxxx.gw.aws-us-east-2.default.tidbcloud.com:443/default?warehouse=xsmall-fsta`
