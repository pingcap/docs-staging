...
Fail-safe in TiDB Cloud Lake is an additional safety feature, different from Time Travel. It's designed to protect your data in case of system issues or security incidents.
...
> **Note:**
>
> - Fail-safe is an emergency service, not user-configurable, provided by TiDB Cloud Lake.
