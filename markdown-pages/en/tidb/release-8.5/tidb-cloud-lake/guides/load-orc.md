...
This tutorial demonstrates how to load data from ORC files stored in an S3 bucket into a TiDB Cloud Lake table.
...
Create a target table in TiDB Cloud Lake to store the data from the ORC files. We choose some of the columns from the ORC files to create the table.
