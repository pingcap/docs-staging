...
summary: Build end-to-end change data capture (CDC) flows in TiDB Lake with two primitives.
---

# Continuous Data Pipelines

Build end-to-end change data capture (CDC) flows in TiDB Lake with two primitives:
