...
- A Linux machine (x86_64 or aarch64 architecture): In this tutorial, we'll deploy TiDB Cloud Lake on a Linux machine. You can use a local machine, a virtual machine, or a cloud instance such as AWS EC2.
    ...
    - If you are on AWS EC2, make sure your security group allows inbound traffic on port `8000`, as this is required for LakeSQL to connect to TiDB Cloud Lake.
...
4. Connect to your TiDB Cloud Lake instance from your local machine with LakeSQL, then apply your TiDB Cloud Lake Enterprise license, create a table, and insert some sample data.
...
2. After the removal, you can verify using LakeSQL that querying the table in TiDB Cloud Lake fails:
