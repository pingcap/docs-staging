...
- Java 8 or 11 is installed on your local machine, as it is required by the [Flink TiDB Lake Connector](https://github.com/databendcloud/flink-connector-databend).
...
2. Download the TiDB Lake and MySQL connectors into the **lib** folder:
...
3. Create corresponding tables with MySQL and TiDB Lake connectors in the Flink SQL Client (replace the placeholders with your actual values):
