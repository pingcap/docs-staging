...
summary: In this tutorial, we'll establish a connection between Kafka in Confluent Cloud and TiDB Cloud Lake using the Kafka Connect sink connector plugin, databend-kafka-connect. Then, we'll demonstrate how to produce messages and load them into TiDB Cloud Lake.
---

# Ingest Kafka with Kafka Connect

In this tutorial, we'll establish a connection between Kafka in Confluent Cloud and TiDB Cloud Lake using the Kafka Connect sink connector plugin, [databend-kafka-connect](https://github.com/databendcloud/databend-kafka-connect). Then, we'll demonstrate how to produce messages and load them into TiDB Cloud Lake.
...
3. Select **Create a schema for message values**, then click **Create Schema**.
    ...
    ![alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/kafka-2.png)
...
![alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/kafka-1.png)

### Step 4: Add a Connector

In this step, you will set up a connector that connects to TiDB Cloud Lake.
...
1. In Confluent Cloud, from the navigation menu, click **Connectors** > **Add Connector**. Search for then select the plugin you uploaded.
    ...
    ![alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/kafka-3.png)
...
2. In the **Kafka credentials** step, select **Use an existing API key**, then enter the API key & secret you created with the Confluent CLI.
    ...
    ![alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/kafka-4.png)
...
4. In the **Networking** step, enter your TiDB Cloud Lake warehouse endpoint, such as `xxxxxxxxx--xxx.gw.aws-us-east-2.default.databend.com`.
...
In this step, you will produce messages using the Confluent CLI and verify that they are loaded into TiDB Cloud Lake.
...
3. In TiDB Cloud Lake, verify that the data has been successfully loaded:

![alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/kafka-5.png)
