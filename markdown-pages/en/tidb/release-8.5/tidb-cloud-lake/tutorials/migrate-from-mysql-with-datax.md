...
In this tutorial, you will load data from MySQL to TiDB Lake with DataX. Before you start, make sure you have successfully set up TiDB Lake, MySQL, and DataX in your environment.
...
2. In TiDB Lake, create a corresponding target table.
    ...
    > **Note:**
    >
    > DataX data types can be converted to TiDB Lake's data types when loaded into TiDB Lake. For the specific correspondences between DataX data types and TiDB Lake's data types, refer to the documentation provided at the following link: <https://github.com/alibaba/DataX/blob/master/databendwriter/doc/databendwriter.md#33-type-convert>
...
You're all set! To verify the data loading, execute the query in TiDB Lake:
