...
In this tutorial, you will load data from MySQL to TiDB Cloud Lake with DataX. Before you start, make sure you have successfully set up TiDB Cloud Lake, MySQL, and DataX in your environment.
...
2. In TiDB Cloud Lake, create a corresponding target table.
    ...
    > **Note:**
    >
    > DataX data types can be converted to TiDB Cloud Lake's data types when loaded into TiDB Cloud Lake. For the specific correspondences between DataX data types and TiDB Cloud Lake's data types, refer to the documentation provided at the following link: <https://github.com/alibaba/DataX/blob/master/databendwriter/doc/databendwriter.md#33-type-convert>
...
You're all set! To verify the data loading, execute the query in TiDB Cloud Lake:
