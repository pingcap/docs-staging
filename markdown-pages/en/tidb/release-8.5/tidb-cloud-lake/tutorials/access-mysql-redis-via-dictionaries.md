...
Before you start, ensure that [Docker](https://www.docker.com/) is installed on your local machine. We need Docker to set up the necessary containers for TiDB Cloud Lake, MySQL, and Redis. You will also need a SQL client to connect to MySQL; we recommend using [LakeSQL](/tidb-cloud-lake/guides/connect-using-lakesql.md) to connect to TiDB Cloud Lake.
