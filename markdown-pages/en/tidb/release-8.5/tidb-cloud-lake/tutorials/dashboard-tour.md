...
1. In TiDB Cloud Lake, click the **Load Data** button on the **Overview** page.
2. On the page that opens, choose the **A new table** radio button, and then select **Covid-19 Data from New York Times.CSV** from the **Load sample data** dropdown menu:
    ...
    ![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-1.png)

3. On the next page, select a database and set a name for the target table to be created.

    ![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-2.png)

4. Click **Confirm**. TiDB Cloud Lake begins creating the target table and loading the dataset. This process may take a few seconds.
...
![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-3.gif)
...
![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-4.gif)
...
![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-5.gif)
...
![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-6.gif)

### Step 3: Adding Charts to Dashboard

1. In TiDB Cloud Lake, create a dashboard on **Dashboards** > **New Dashboard**, then click **Add Chart** on the dashboard.

2. Drag and drop the charts from the left onto the dashboard. You can resize or reposition a chart as needed.

![Alt text](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/dashboard-7.gif)
