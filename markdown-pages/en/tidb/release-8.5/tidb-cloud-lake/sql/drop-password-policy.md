...
summary: Deletes an existing password policy from TiDB Cloud Lake. Please note that, before dropping a password policy, ensure that this policy is not associated with any users.
---
