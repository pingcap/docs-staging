...
|-----------|---------------------------------------------------------------------------------------------------|
| `<arg>`   | Argument of [any data type that TiDB Lake supports](/tidb-cloud-lake/sql/data-types.md) |
| `<val>`   | Value of [any data type that TiDB Lake supports](/tidb-cloud-lake/sql/data-types.md)    |
