...
|-----------|---------------------------------------------------------------------------------------------------|
| `<arg>`   | Argument of [any data type that TiDB Cloud Lake supports](/tidb-cloud-lake/sql/data-types.md) |
| `<val>`   | Value of [any data type that TiDB Cloud Lake supports](/tidb-cloud-lake/sql/data-types.md)    |
