...
summary: This section provides reference information for JSON functions in TiDB Cloud Lake. JSON functions enable parsing, validation, querying, and manipulation of JSON data structures.
---

# JSON Functions

This section provides reference information for JSON functions in TiDB Cloud Lake. JSON functions enable parsing, validation, querying, and manipulation of JSON data structures.
