---
title: Map Functions
summary: This section provides reference information for the map functions in TiDB Cloud Lake. Map functions allow you to create, manipulate, and extract information from map data structures (key-value pairs).
---

# Map Functions

This section provides reference information for the map functions in TiDB Cloud Lake. Map functions allow you to create, manipulate, and extract information from map data structures (key-value pairs).
