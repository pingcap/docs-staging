...
summary: The REFRESH VIRTUAL COLUMN command in TiDB Cloud Lake is used to explicitly trigger the creation of virtual columns for existing tables. While TiDB Cloud Lake automatically manages virtual columns for new data, there are specific scenarios where manual refreshing is necessary to take full advantage of this feature.
---
