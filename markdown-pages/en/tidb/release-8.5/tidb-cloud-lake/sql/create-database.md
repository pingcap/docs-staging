...
> - When both options are set, TiDB Cloud Lake validates that the connection exists, the path URI is well-formed, and the storage location is accessible.
...
> **Note:**
>
> To use IAM roles with TiDB Cloud Lake, you need to set up a trust relationship between your AWS account and TiDB Cloud Lake. See [Authenticate with AWS IAM Role](/tidb-cloud-lake/guides/authenticate-with-aws-iam-role.md) for detailed instructions.
