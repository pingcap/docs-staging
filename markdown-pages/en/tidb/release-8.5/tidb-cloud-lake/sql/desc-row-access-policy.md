...
summary: "Displays detailed information about a specific row access policy in TiDB Cloud Lake."
---

# DESC ROW ACCESS POLICY

Displays detailed information about a specific row access policy in TiDB Cloud Lake.
