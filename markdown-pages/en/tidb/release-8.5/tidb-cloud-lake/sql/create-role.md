---
title: CREATE ROLE
summary: Creates a new role for access control. Roles are used to group privileges and can be assigned to users or other roles, providing a flexible way to manage permissions in TiDB Cloud Lake.
---
...
Creates a new role for access control. Roles are used to group privileges and can be assigned to users or other roles, providing a flexible way to manage permissions in TiDB Cloud Lake.
