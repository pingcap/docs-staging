---
title: FUSE_BLOCK
summary: Returns the block information of the latest or specified snapshot of a table. For more information about what is block in TiDB Lake, see What are Snapshot, Segment, and Block?.
---

# FUSE_BLOCK

Returns the block information of the latest or specified snapshot of a table. For more information about what is block in TiDB Lake, see [What are Snapshot, Segment, and Block?](/tidb-cloud-lake/sql/optimize-table.md#-lake-short--data-storage-snapshot-segment-and-block).
