---
title: FUSE_SNAPSHOT
summary: Returns the snapshot information of a table. For more information about what is snapshot in TiDB Cloud Lake, see What are Snapshot, Segment, and Block?.
---

# FUSE_SNAPSHOT

Returns the snapshot information of a table. For more information about what is snapshot in TiDB Cloud Lake, see [What are Snapshot, Segment, and Block?](/tidb-cloud-lake/sql/optimize-table.md#-lake--data-storage-snapshot-segment-and-block).
