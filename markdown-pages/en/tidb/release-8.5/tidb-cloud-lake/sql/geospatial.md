---
title: Geospatial
summary: "TiDB Lake stores spatial data through two data types."
---

# Geospatial

TiDB Lake stores spatial data through two data types:
...
TiDB Lake persists spatial values as EWKB but exposes several output formats. Set the `geometry_output_format` session setting (default: `WKT`) or call explicit conversion functions:
