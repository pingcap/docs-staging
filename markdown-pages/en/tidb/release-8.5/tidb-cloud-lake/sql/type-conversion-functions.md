...
summary: This section provides reference information for type conversion functions in TiDB Cloud Lake. These functions enable strict casting of VARIANT values to other SQL data types.
---
