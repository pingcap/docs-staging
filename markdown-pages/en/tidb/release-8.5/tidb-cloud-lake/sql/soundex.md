...
- A Soundex code consists of a letter followed by three numerical digits. TiDB Lake's implementation returns more than 4 digits, but you can [SUBSTR](/tidb-cloud-lake/sql/substr.md) the result to get a standard Soundex code.
