...
**Complete SQL execution audit trail** - Records comprehensive details of all SQL queries executed in TiDB Lake. Each query generates two entries (start and finish), providing complete visibility into:
