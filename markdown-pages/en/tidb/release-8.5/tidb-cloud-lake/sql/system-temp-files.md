...
summary: Contains information about temporary files created by TiDB Cloud Lake, such as spill files. To remove the temporary files, use the VACUUM TEMPORARY FILES command.
---
...
Contains information about temporary files created by TiDB Cloud Lake, such as spill files. To remove the temporary files, use the [VACUUM TEMPORARY FILES](/tidb-cloud-lake/sql/vacuum-temporary-files.md) command.
