...
summary: Deletes an existing network policy from TiDB Lake. When you drop a network policy, it is removed from TiDB Lake, and its associated rules for allowed and blocked IP address lists are no longer in effect. Please note that, before dropping a network policy, ensure that this policy is not associated with any users.
---
...
Deletes an existing network policy from TiDB Lake. When you drop a network policy, it is removed from TiDB Lake, and its associated rules for allowed and blocked IP address lists are no longer in effect. Please note that, before dropping a network policy, ensure that this policy is not associated with any users.
