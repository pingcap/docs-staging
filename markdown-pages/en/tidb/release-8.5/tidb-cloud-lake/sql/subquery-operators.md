...
summary: A subquery is a query nested within another one. TiDB Lake supports the following subquery types.
---

# Subquery Operators

A subquery is a query nested within another one. TiDB Lake supports the following subquery types:
...
- If a scalar subquery returns 0 rows, TiDB Lake will use NULL as the subquery output.
- If a scalar subquery returns more than one row, TiDB Lake will throw an error.
