...
summary: Displays detailed information about a specific password policy in TiDB Lake. For detailed descriptions of the password policy attributes, see Password Policy Attributes.
---
...
Displays detailed information about a specific password policy in TiDB Lake. For detailed descriptions of the password policy attributes, see [Password Policy Attributes](/tidb-cloud-lake/sql/create-password-policy.md#password-policy-attributes).
