...
TiDB Cloud Lake can connect to [Apache Iceberg™](https://iceberg.apache.org/) catalogs so that you can query Iceberg tables without loading their data into Fuse tables. You can also create and write Iceberg tables when the connected catalog supports write operations.
...
| --- | --- | --- |
| `<catalog_name>` | Yes | Name of the catalog in TiDB Cloud Lake. |
...
| TiDB Cloud Lake Type | Apache Iceberg™ Type |
| --- | --- |
| BOOLEAN | Boolean |
| INT | Int |
| BIGINT | Long |
