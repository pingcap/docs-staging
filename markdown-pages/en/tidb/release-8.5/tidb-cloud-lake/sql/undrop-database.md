...
summary: Restores the most recent version of a dropped database. This leverages the TiDB Lake Time Travel feature; a dropped object can be restored only within a retention period (defaults to 24 hours).
---

# UNDROP DATABASE

Restores the most recent version of a dropped database. This leverages the TiDB Lake Time Travel feature; a dropped object can be restored only within a retention period (defaults to 24 hours).
