...
| hive_parquet_chunk_size | 16384 | 16384 | DEFAULT | The max number of rows each read from parquet to TiDB Cloud Lake processor. | UInt64 |
...
| query_result_cache_allow_inconsistent | 0 | 0 | DEFAULT | Determines whether TiDB Cloud Lake will return cached query results that are inconsistent with the underlying data. | UInt64 |
