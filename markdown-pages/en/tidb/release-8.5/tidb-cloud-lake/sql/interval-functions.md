...
summary: This section provides reference information for the interval functions in TiDB Cloud Lake. Interval functions allow you to create interval values of various time units for use in date and time calculations.
---

# Interval Functions

This section provides reference information for the interval functions in TiDB Cloud Lake. Interval functions allow you to create interval values of various time units for use in date and time calculations.
