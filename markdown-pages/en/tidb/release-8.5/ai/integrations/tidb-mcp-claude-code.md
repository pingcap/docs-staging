...
1. On the [**My TiDB**](https://tidbcloud.com/tidbs) page, click the name of your target TiDB Cloud Starter instance to go to its overview page, and then click **Use with AI Tools** in the upper-right corner.
