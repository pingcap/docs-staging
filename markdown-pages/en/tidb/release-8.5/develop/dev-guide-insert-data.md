...
For more information on how to use this SQL, see [Connect to a TiDB Cloud Starter instance](/develop/dev-guide-build-cluster-in-cloud.md#step-2-connect-to-a-starter-instance) and follow the steps to enter the SQL statement after connecting to a TiDB Cloud Starter instance using a client.
...
- Data export: use [Dumpling](/dumpling-overview.md) to export MySQL or TiDB data to local or your cloud storage. For a TiDB Cloud Starter or Essential instance, you can also use the [Export](/tidb-cloud/serverless-export.md) feature in the [TiDB Cloud console](https://tidbcloud.com/) to export data more efficiently.
