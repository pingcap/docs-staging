...
- To connect to TiDB Cloud Starter or TiDB Cloud Essential instances from edge environments via HTTP, use the [TiDB Cloud Serverless Driver](/develop/serverless-driver.md). Note that the serverless driver is in public preview and only applicable to TiDB Cloud Starter or TiDB Cloud Essential instances.
