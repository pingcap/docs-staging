...
2. Import the downloaded metrics file on Grafana:
    ...
    ![Import Metrics File](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-import-grafana.png)
...
![Summary](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-metric-summary.png)
...
![Server](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-metric-server.png)
...
![Log Puller](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-metric-log-puller.png)
...
![Event Store](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-metric-event-store.png)
...
![Sink](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-metric-sink.png)
