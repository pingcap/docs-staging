...
![TiCDC New Architecture](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-1.png)
...
![Comparison between the TiCDC classic and new architectures](https://docs-download.pingcap.com/media/images/docs/ticdc/ticdc-new-arch-2.png)
...
2. If your TiDB cluster version is earlier than v8.5.4, you need to manually download the TiCDC binary package of the new architecture, and then patch the downloaded file to your TiDB cluster. Otherwise, skip this step.
    ...
    For example, to download the binary package of TiCDC v8.5.8 for Linux (x86-64), run the following command:
