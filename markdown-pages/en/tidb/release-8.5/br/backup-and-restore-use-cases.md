...
To use PITR, you need to deploy a TiDB cluster >= v6.2.0 and update BR to the same version as the TiDB cluster. This document uses v8.5.7 as an example.
...
- Install:
    ...
    ```shell
    tiup install br:v8.5.7
    ```

- Upgrade:

    ```shell
    tiup update br:v8.5.7
    ```
