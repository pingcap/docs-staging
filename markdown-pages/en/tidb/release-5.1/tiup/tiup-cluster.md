...
Save the file as `/tmp/topology.yaml`. If you want to use TiDB v5.1.4 and your cluster name is `prod-cluster`, run the following command:
...
For example, the following command upgrades the cluster to v5.1.4:
