...
- Data import: [Create Import](/tidb-cloud/import-sample-data.md) page in the [TiDB Cloud console](https://tidbcloud.com/). You can upload local CSV files (TiDB Cloud Starter only), and import **Dumpling** logical dumps (schema and data), **CSV**, or **Parquet** files stored in Cloud Storage. For details, see the [Import CSV Files into TiDB Cloud Starter](/tidb-cloud/import-csv-files-serverless.md) or [Import CSV Files into TiDB Cloud Dedicated](/tidb-cloud/import-csv-files.md).
