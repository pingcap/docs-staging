...
> **Note:**
>
> `{version}` indicates the version number of TiDB. For example, if `{version}` is `v6.0.0`, the package download link is `https://download.pingcap.org/tidb-community-server-v6.0.0-linux-amd64.tar.gz`.
