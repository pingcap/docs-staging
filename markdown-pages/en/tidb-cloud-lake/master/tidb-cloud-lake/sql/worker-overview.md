...
> **Note:**
>
> Worker management commands require cloud control. If `cloud_control_grpc_server_address` is not configured, TiDB Cloud Lake returns a `CloudControlNotEnabled` error when you run these commands.
