...
summary: This section provides reference information for type predicate functions in TiDB Cloud Lake. These functions enable type checking, validation, and conversion of JSON values.
---
