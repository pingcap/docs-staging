...
- Staged files: TiDB Cloud Lake enables you to replace data into a table from staged files with the REPLACE INTO statement. This is achieved through TiDB Cloud Lake's capacity to [Query Staged Files](/tidb-cloud-lake/sql/stage.md) and subsequently incorporate the query result into the table.
