...
> **Note:**
>
> This function is currently supported only through the MySQL protocol, meaning you must connect to TiDB Cloud Lake using a MySQL protocol-compatible client for it to work.
