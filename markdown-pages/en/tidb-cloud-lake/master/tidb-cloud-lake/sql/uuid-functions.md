...
summary: This page provides reference information for the UUID-related functions in TiDB Cloud Lake. These functions generate and work with Universally Unique Identifiers (UUIDs).
---
