...
1. Connect to TiDB Cloud Lake using LakeSQL. If you're unfamiliar with LakeSQL, refer to this tutorial: [Connecting to TiDB Cloud Lake using LakeSQL](/tidb-cloud-lake/guides/connect-using-lakesql.md).
...
4. In the Flink SQL Client, synchronize the data from the mysql_products table to the databend_products table:
    ...
    You're all set! If you go back to the LakeSQL terminal and query the **products** table in TiDB Cloud Lake, you will see that the data from MySQL has been successfully synchronized:
