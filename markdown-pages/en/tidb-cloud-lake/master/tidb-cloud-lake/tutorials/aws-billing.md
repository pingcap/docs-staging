...
summary: In this tutorial, we'll walk you through the process of importing AWS billing data and conducting cost analysis using SQL. You'll learn how to load the AWS billing data into TiDB Cloud Lake, query it to find key cost drivers, and gain insights into your AWS usage.
---

# TiDB Cloud Lake - AWS Billing

In this tutorial, we'll walk you through the process of importing AWS billing data and conducting cost analysis using SQL. You'll learn how to load the AWS billing data into TiDB Cloud Lake, query it to find key cost drivers, and gain insights into your AWS usage.
...
In this step, you'll load the AWS billing dataset into TiDB Cloud Lake with just a few clicks.
