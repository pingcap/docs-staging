...
2. Set your MinIO credentials as environment variables, then use the AWS CLI to create two buckets: one for storing backups (**backupbucket**) and another for TiDB Cloud Lake data (**lake**):
...
3. Run the following command to restore your TiDB Cloud Lake data to the **lake** bucket in MinIO:
