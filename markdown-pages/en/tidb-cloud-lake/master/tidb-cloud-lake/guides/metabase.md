...
TiDB Cloud Lake provides a JDBC driver named [Metabase TiDB Cloud Lake Driver](https://github.com/databendcloud/metabase-databend-driver/releases/latest), enabling you to connect to Metabase and dashboard your data in TiDB Cloud Lake / TiDB Cloud Lake. For more information about the Metabase TiDB Cloud Lake Driver, refer to <https://github.com/databendcloud/metabase-databend-driver>

## Downloading & Installing Metabase TiDB Cloud Lake Driver

To download and install the Metabase TiDB Cloud Lake Driver:
...
2. [Download](https://github.com/databendcloud/metabase-databend-driver/releases/latest) the Metabase TiDB Cloud Lake Driver, then save it in the **plugins** folder.
...
This tutorial guides you through the process of integrating TiDB Cloud Lake / TiDB Cloud Lake with Metabase using the Metabase TiDB Cloud Lake Driver.
...
For this tutorial, you will integrate with TiDB Cloud Lake. Make sure you can log in to your TiDB Cloud account and obtain the connection information for a warehouse. For more details, see [Connecting to a Warehouse](/tidb-cloud-lake/guides/warehouse.md#connecting-to-a-warehouse).
