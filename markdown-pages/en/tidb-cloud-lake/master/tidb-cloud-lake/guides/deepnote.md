---
title: Connect to TiDB Cloud Lake with Deepnote
...
# Connect to TiDB Cloud Lake with Deepnote
...
You can connect Deepnote to TiDB Cloud Lake by using Deepnote's ClickHouse-compatible integration with a secure connection.

## Tutorial: Integrating with Deepnote

This tutorial guides you through the process of integrating TiDB Cloud Lake with Deepnote.

### Step 1. Set up Environment

Make sure you can log in to your TiDB Cloud Lake account and obtain the connection information for a warehouse. For more details, see [Connecting to a Warehouse](/tidb-cloud-lake/guides/warehouse.md#connecting-to-a-warehouse).

### Step 2. Connect to TiDB Cloud Lake
...
2. Click **+** to the right of **INTEGRATIONS** in the left sidebar, then select **ClickHouse**.
    ...
    ![Integration with ClickHouse](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/integration-clickhouse.png)
