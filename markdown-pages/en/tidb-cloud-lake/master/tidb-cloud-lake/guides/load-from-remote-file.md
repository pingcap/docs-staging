...
This tutorial demonstrates how to import data into TiDB Cloud Lake from a remote CSV file. The sample file [books.csv](https://lakesql-bin.tidbcloud.com/datasets/books.csv) contains two records:
