---
title: "TiDB Cloud Lake vs. Snowflake: Data Ingestion Benchmark"
summary: This page presents a benchmark comparison of data ingestion performance and cost between TiDB Cloud Lake and Snowflake, focusing on TPC-H SF100 dataset loading, ClickBench Hits dataset loading, and freshness benchmarks.
---
...
- **[TiDB Cloud Lake](https://tidbcloud.com)**: A cloud-native data warehouse focusing on scalability and cost-efficiency.
...
![Data loading benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/data-loading-benchmark.png)

### TPC-H SF100 Dataset

| Metric         | Snowflake | TiDB Cloud Lake | Description               |
| -------------- | --------- | -------------- | ------------------------- |
...
![Freshness benchmark](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/freshness-benchmark.png)
...
1. Create an [external stage](/tidb-cloud-lake/sql/create-stage.md#example-2-create-external-stage-with-connection) in TiDB Cloud Lake.
