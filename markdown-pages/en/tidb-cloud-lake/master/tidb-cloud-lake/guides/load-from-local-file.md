...
summary: Uploading your local data files to a stage or bucket before loading them into TiDB Cloud Lake can be unnecessary. Instead, you can use LakeSQL, the TiDB Cloud Lake native CLI tool, to directly import the data. This simplifies the workflow and can save you storage fees.
---

# Loading from Local File

Uploading your local data files to a stage or bucket before loading them into TiDB Cloud Lake can be unnecessary. Instead, you can use [LakeSQL](/tidb-cloud-lake/guides/connect-using-lakesql.md), the TiDB Cloud Lake native CLI tool, to directly import the data. This simplifies the workflow and can save you storage fees.
...
This tutorial uses a CSV file as an example to demonstrate how to import data into TiDB Cloud Lake using [LakeSQL](/tidb-cloud-lake/guides/connect-using-lakesql.md) from a local source.
...
> **Note:**
>
> Be sure that you are able to connect to the backend object storage for TiDB Cloud Lake from local LakeSQL directly.
