...
If you're new to dbt, TiDB Cloud Lake recommends completing the official dbt tutorial available at <https://github.com/dbt-labs/jaffle_shop>. Before you start, follow [Install tidbcloudlake-dbt](#install-tidbcloudlake-dbt) to install dbt and tidbcloudlake-dbt.
