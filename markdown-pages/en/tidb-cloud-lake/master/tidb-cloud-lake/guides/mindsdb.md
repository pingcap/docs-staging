...
1. Copy and paste the following SQL statements to the MindsDB Cloud Editor, and click **Run**:
    ...
    > **Tip:**
    >
    > The SQL statements above connect the database `default` in TiDB Cloud Lake to your MindsDB Cloud account. For explanations about the parameters, refer to <https://mindsdb.github.io/engine/#db-create>.
