...
![FeiShu notification example](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/feishubot-example.png)
...
`FeiShuBot` is a notification-oriented data source. It is not used to load business data into TiDB Cloud Lake.
