...
| [**Authenticate with AWS IAM Role**](/tidb-cloud-lake/guides/authenticate-with-aws-iam-role.md) | Use AWS IAM roles for authentication | When you want to leverage AWS IAM for secure access to TiDB Cloud Lake |
