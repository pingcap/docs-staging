---
title: Data Lineage
summary: Learn how to enable and explore data lineage in TiDB Cloud Lake.
---
...
TiDB Cloud Lake records both object-level and column-level relationships:
...
![Table and column lineage in TiDB Cloud Lake](https://docs-download.pingcap.com/media/images/docs/tidb-cloud-lake/data-lineage.png)

## Enable Data Lineage

TiDB Cloud Lake manages lineage configuration for warehouses that support the **Lineage** tab (**Data** > **Databases** > **databaseName** > **tableName**).

## Generate Lineage

After lineage is enabled, TiDB Cloud Lake automatically records relationships created by operations such as `CREATE TABLE ... AS SELECT`, `CREATE VIEW`, `INSERT ... SELECT`, multi-table `INSERT`, `REPLACE`, `MERGE`, and `COPY`. Streams are resolved to their backing tables.
...
In TiDB Cloud Lake, open a table or view in Database Explorer and select the **Lineage** tab. The graph displays upstream and downstream objects, with column connections when column lineage is available.
