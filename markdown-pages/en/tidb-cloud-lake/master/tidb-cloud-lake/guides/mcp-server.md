...
[tidbcloud/lake-mcp](https://github.com/tidbcloud/lake-mcp) is an MCP (Model Context Protocol) server that enables AI assistants to interact directly with your TiDB Cloud Lake database using natural language.
...
1. **TiDB Cloud Lake Database** - Either [TiDB Cloud Lake](https://app.lake.tidbcloud.com) (free tier available) or a self-hosted instance
...
1. **Sign up for [TiDB Cloud Lake](https://app.lake.tidbcloud.com)** (free tier available)
