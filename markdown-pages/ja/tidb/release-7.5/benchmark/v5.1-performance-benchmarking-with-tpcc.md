...
summary: TiDB v5.1.0のTPC-Cパフォーマンスは、v5.0.2と比較して2.8%向上しています。AWS EC2でのテスト環境とハードウェア構成は同じです。テスト計画ではTiUPを使用してTiDBをデプロイし、BenchmarkSQLを使用してTPC-C Warehouseデータをインポートしました。
---
