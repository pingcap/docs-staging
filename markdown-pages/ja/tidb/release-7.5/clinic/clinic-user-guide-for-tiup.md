...
summary: PingCAPクリニックを使用して、TiUPを使用してデプロイされたTiDBクラスターおよびDMクラスターのトラブルシューティングをリモートで行うことができます。また、クラスターのステータスをローカルで簡単にチェックすることも可能です。データはクリニックサーバーにアップロードされ、180日間保存されます。
---
