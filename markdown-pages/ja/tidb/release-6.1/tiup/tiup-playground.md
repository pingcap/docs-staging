...
-   このコマンドは TiDB、PD、および TiKV コンポーネントのバージョンを指定しないため、TiUP プレイグラウンドはデフォルトで各コンポーネントの最新バージョンを使用します。最新バージョンが v6.1.0 であると仮定すると、このコマンドは`tiup playground:v1.10.0 v6.1.0`と同じように機能します。
