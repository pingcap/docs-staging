...
-   パッケージの特定のバージョンを複製するかどうかを決定します
    ...
    -   `tiup mirror clone <target-dir> --tidb v6.1.3`コマンドを実行して、v6.1.3 バージョンの TiDB コンポーネントを複製します。
    -   `tiup mirror clone <target-dir> --tidb v6.1.3 --tikv all`コマンドを実行して、TiDB コンポーネントの v6.1.3 バージョンと TiKV コンポーネントのすべてのバージョンを複製します。
    -   `tiup mirror clone <target-dir> v6.1.3`コマンドを実行して、クラスター内のすべてのコンポーネントの v6.1.3 バージョンを複製します。
