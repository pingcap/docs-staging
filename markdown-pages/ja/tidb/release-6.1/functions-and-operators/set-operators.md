...
TiDB は、集合操作での[`ORDER BY`](https://docs-download.pingcap.com/media/images/docs/sqlgram/OrderByOptional.png)つまたは[`LIMIT`](https://docs-download.pingcap.com/media/images/docs/sqlgram/LimitClause.png)の句の使用をサポートしています。これら 2 つの句は、ステートメント全体の最後にある必要があります。
