...
# TiDB TPC-C パフォーマンス テスト レポート -- v5.4.0 対 v5.3.0 {#tidb-tpc-c-performance-test-report-v5-4-0-vs-v5-3-0}

## テストの概要 {#test-overview}

このテストは、オンライン トランザクション処理 (OLTP) シナリオで TiDB v5.4.0 と v5.3.0 の TPC-C パフォーマンスを比較することを目的としています。結果は、v5.3.0 と比較して、v5.4.0 の TPC-C パフォーマンスが 3.16% 向上したことを示しています。
