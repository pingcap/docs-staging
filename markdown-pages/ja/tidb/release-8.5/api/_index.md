...
| [TiDB Operator API](https://github.com/pingcap/tidb-operator/blob/v1.6.4/docs/api-references/docs.md) | Kubernetes 上で TiDB クラスタを管理します。これには、デプロイ、アップグレード、スケーリング、バックアップ、フェイルオーバーなどが含まれます。 |
