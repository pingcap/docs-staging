...
> - ベクトルデータ型は、 [TiDB Self-Managed](/overview.md) および [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier/?plan=starter#starter) で使用できます。TiDB Self-Managedの場合、TiDBバージョンはv8.4.0以降である必要があります（v8.5.0以降を推奨）。
...
### VEC_NEGATIVE_INNER_PRODUCT {#vec_negative_inner_product}
...
### VEC_L1_DISTANCE {#vec_l1_distance}
