...
> - ベクトル検索機能は、[TiDB Self-Managed](/overview.md) と [TiDB Cloud Starter](/tidb-cloud/select-cluster-tier.md#starter) で利用できます。TiDB Self-Managed では、TiDB バージョンが v8.4.0 以降である必要があります（v8.5.0 以降を推奨します）。
