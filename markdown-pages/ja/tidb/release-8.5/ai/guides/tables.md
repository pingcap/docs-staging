...
- Python 3.10 以降。
- TiDB Cloud Starter インスタンス。 [TiDB Cloud](https://tidbcloud.com/free-trial) で作成できます。
...
3. [TiDB Cloud コンソール](https://tidbcloud.com/) で [**My TiDB**](https://tidbcloud.com/tidbs) ページに移動し、TiDB Cloud Starter インスタンスの名前をクリックしてから、右上隅の **Connect** をクリックして接続パラメータを取得します。
