...
- TiDB Dashboardにログインしたら、左側のナビゲーション メニューで**Resource Manager**をクリックします。
...
- **Total RU Consumed**: リアルタイムでカウントされたリクエストユニットの合計消費量。
- **RU Consumed by Resource Groups**: リソースグループによってリアルタイムで消費されたリクエストユニットの数。
- TiDB
