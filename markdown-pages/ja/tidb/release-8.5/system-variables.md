...
> **Note:**
>
> [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter)、[TiDB Cloud Essential](https://docs.pingcap.com/tidbcloud/select-cluster-tier#essential)、および [TiDB Cloud Premium](https://docs.pingcap.com/tidbcloud/select-cluster-tier#premium) では、この変数は読み取り専用です。
...
> **Note:**
>
> TiDB Cloud Premium の場合、この変数は読み取り専用です。
...
> **Note:**
>
> - [TiDB Cloud Starter](https://docs.pingcap.com/tidbcloud/select-cluster-tier#starter) および [TiDB Cloud Essential](https://docs.pingcap.com/tidbcloud/select-cluster-tier#essential) では、この変数は読み取り専用です。
> - [TiDB Cloud Premium](https://docs.pingcap.com/tidbcloud/select-cluster-tier#premium) では、この TiDB 変数の変更は `MODIFY COLUMN` DDL ジョブにのみ有効で、`ADD INDEX` DDL ジョブには影響しません。
