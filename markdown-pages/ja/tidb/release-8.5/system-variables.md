...
> **警告：**
>
> 現在、 `PREDICATE COLUMNS`に関する統計情報の収集は実験的機能です。本番環境での使用は推奨されません。
...
-   デフォルト値: `0`
-   範囲: `[0, 1]`
-   この変数は、SQL ステートメントにフィルタ条件を持つ句が`ORDER BY`つと`LIMIT`ある場合に、オプティマイザがインデックスを選択する方法を制御するために使用されます。
