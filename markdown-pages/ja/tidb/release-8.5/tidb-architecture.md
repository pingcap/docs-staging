...
TiDB には、クラシック TiDBアーキテクチャと[TiDB Xアーキテクチャ](/tidb-cloud/tidb-x-architecture.md)という 2つのアーキテクチャがあります。このドキュメントでは、クラシック TiDBアーキテクチャについて説明します。
