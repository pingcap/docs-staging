...
| アクセスオブジェクト | オペレーターがアクセスするデータ項目情報。この情報には、`table`、`index`（存在する場合）、`partition`が含まれます。この情報は、データに直接アクセスするオペレーターのみが使用できます。                                                                                                                                                                                                  |
| オペレーター情報   | オペレーターに関するその他の情報。オペレーターごとに`operator info`が異なります。以下の例を参照してください。                                                                                                                                                                                                                                                      |
