...
- TiDBに接続する
  ...
  - TiDB Cloud Serverless Driver ![PREVIEW](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/blank_transparent_placeholder.png)
    ...
    - [Drizzleの例](/develop/serverless-driver-drizzle-example.md)
- データベーススキーマの設計
...
- データを書き込む
  ...
  - [TTL (Time to Live)を使用して、期限切れのデータを定期的に削除する](/develop/dev-guide-time-to-live.md)
...
- [ベクトル検索](/develop/dev-guide-vector-search.md) ![PREVIEW](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/blank_transparent_placeholder.png)
- トランザクションの管理
