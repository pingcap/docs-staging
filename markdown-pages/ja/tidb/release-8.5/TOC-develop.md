...
-   TiDBに接続する
    ...
    -   TiDB Cloud Serverless Driver ![BETA](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/blank_transparent_placeholder.png)
...
-   [ベクトル検索](/develop/dev-guide-vector-search.md)![BETA](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/blank_transparent_placeholder.png)
-   トランザクションの管理
