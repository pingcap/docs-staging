...
-   パッケージの特定のバージョンを複製するかどうかを決定します
    ...
    -   `tiup mirror clone <target-dir> --tidb v6.3.0`コマンドを実行して、TiDB コンポーネントの v6.3.0 バージョンを複製します。
    -   `tiup mirror clone <target-dir> --tidb v6.3.0 --tikv all`コマンドを実行して、TiDB コンポーネントの v6.3.0 バージョンと TiKV コンポーネントのすべてのバージョンを複製します。
    -   `tiup mirror clone <target-dir> v6.3.0`コマンドを実行して、クラスター内のすべてのコンポーネントの v6.3.0 バージョンを複製します。
