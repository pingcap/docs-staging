...
-   このコマンドはプレイグラウンド コンポーネントのバージョンを指定しないため、TiUP はインストールされているプレイグラウンド コンポーネントの最新バージョンを最初にチェックします。最新バージョンが v1.11.0 であると仮定すると、このコマンドは`tiup playground:v1.11.0`と同じように機能します。
...
-   このコマンドは TiDB、PD、および TiKV コンポーネントのバージョンを指定しないため、TiUP プレイグラウンドはデフォルトで各コンポーネントの最新バージョンを使用します。最新バージョンが v6.3.0 であると仮定すると、このコマンドは`tiup playground:v1.11.0 v6.3.0`と同じように機能します。
