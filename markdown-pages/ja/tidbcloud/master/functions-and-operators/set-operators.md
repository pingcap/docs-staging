...
TiDBは、集合演算での[`ORDER BY`](https://download.pingcap.com/images/docs/sqlgram/OrderByOptional.png)つまたは[`LIMIT`](https://download.pingcap.com/images/docs/sqlgram/LimitClause.png)の句の使用をサポートしています。これらの2つの句は、ステートメント全体の最後にある必要があります。
