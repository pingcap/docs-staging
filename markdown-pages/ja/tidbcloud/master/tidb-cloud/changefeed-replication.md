...
> -   **TiDB Cloudレプリケーションは**リクエストがあった場合にのみ利用可能です。この機能をリクエストするには、 **「?」**をクリックしてください。 [TiDB Cloudコンソール](https://tidbcloud.com)の右下隅にある**[チャット] を**クリックします。次に、「**説明**」フィールドに「 TiDB Cloudレプリケーションの申請」と入力し、 **「送信」**をクリックします。
