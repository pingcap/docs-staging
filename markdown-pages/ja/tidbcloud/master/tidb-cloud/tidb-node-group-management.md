...
1.  [TiDB Cloudコンソール](https://tidbcloud.com/)で、[**My TiDB**](https://tidbcloud.com/tidbs)ページに移動し、ターゲット クラスターの名前をクリックして概要ページに移動します。
...
1.  [**My TiDB**](https://tidbcloud.com/tidbs)ページに移動し、ターゲット クラスターの名前をクリックして概要ページに移動します。
...
2.  [**My TiDB**](https://tidbcloud.com/tidbs)ページに移動し、ターゲット クラスターの名前をクリックして概要ページに移動します。
...
1.  [**My TiDB**](https://tidbcloud.com/tidbs)ページに移動し、ターゲット クラスターの名前をクリックして概要ページに移動します。
2.  左側のナビゲーション ペインで**Nodes**をクリックして、TiDB ノード グループのリストを表示します。
