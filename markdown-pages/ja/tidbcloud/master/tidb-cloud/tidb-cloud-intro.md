...
-   TiDB Cloud BYOC
    ...
    TiDB Cloud BYOCは、より高度な制御、セキュリティ、およびコンプライアンスを必要とする大規模な本番ワークロード向けに設計されています。TiDB Cloudの自動運用、伸縮自在なスケーラビリティ、エンタープライズグレードのセキュリティの利点を活用しながら、自身のAWSアカウントでデータプレーンを実行できます。

    現在、TiDB Cloud BYOCはAWSでプライベートプレビュー版として提供されています。
