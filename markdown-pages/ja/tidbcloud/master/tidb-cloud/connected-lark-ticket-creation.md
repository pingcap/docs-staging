...
TiDB Cloud **Enterprise** [サポートプラン](/tidb-cloud/connected-care-detail.md)をご契約のお客様には、 [ラーク](https://www.larksuite.com/)で**「PingCAP Support Bot」**と呼ばれるチケットボットをご利用いただけます。このボットは、サポートチケットの作成や、サポートチケットシステムからの最新情報の直接受信に役立ちます。
...
チケットが作成されると、ボットはスレッド内のチケットリンクを返信します。リンクをクリックすると、 [PingCAP ヘルプセンター](https://tidb.support.pingcap.com/servicedesk/customer/portals)でチケットの詳細を確認できます。

![lark-ticket-creation-3](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/connected-lark-ticket-creation-3.png)

![lark-ticket-creation-4](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/connected-lark-ticket-creation-4.png)
...
![lark-ticket-creation-5](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/connected-lark-ticket-creation-5.png)
