...
[n8n](https://n8n.io/)は拡張可能なワークフロー自動化ツールです。[FairCode](https://faircode.io/)配布モデルを採用しているため、n8nは常にソースコードが公開されており、セルフホストが可能で、独自の関数、ロジック、アプリケーションを追加できます。
...
1. RSS Feed Readノードの右側にある**+**をクリックします。
