...
- [TiDB Cloud {{{ .byoc }}}インスタンスを作成する](/tidb-cloud/byoc/create-tidb-instance-byoc.md)
...
> **Note:**
        >
        > - {{{ .byoc }}} インスタンスでは、プロジェクトは任意です。データプレーンはお客様自身のクラウドアカウントで実行され、BYOC 環境レベルの設定は BYOC オンボーディング時に構成されます。
