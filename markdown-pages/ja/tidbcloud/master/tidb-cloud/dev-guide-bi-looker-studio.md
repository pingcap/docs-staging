...
3.  **基本**設定ペインで、接続パラメータを構成します。
    ...
    ![Looker Studio: configure connection settings for TiDB Serverless](https://download.pingcap.com/images/docs/tidb-cloud/looker-studio-configure-connection.png)
