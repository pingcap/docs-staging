...
2.  **「新しいARNの追加」**ダイアログを開きます。
    ...
    -   データをAmazon S3にエクスポートする場合は、次のように**「新しいARNの追加」**ダイアログを開きます。
        ...
        1.  **「データのエクスポート先...」** &gt; **「Amazon S3」**をクリックします。TiDB TiDB Cloud StarterまたはEssentialインスタンスでこれまでデータのインポートまたはエクスポートが行われていない場合は、ページ下部の**「ここをクリックしてデータをエクスポート...」** &gt; **「Amazon S3」**をクリックしてください。
...
2.  **「ARMテンプレート展開による新しいSASトークンの生成」**ダイアログを開きます。
    ...
    -   データをAzure Blob Storageにエクスポートする場合：
        ...
        1.  **「データのエクスポート先...」** &gt; **「Azure Blob Storage」**をクリックします。TiDB TiDB Cloud StarterまたはEssentialインスタンスでこれまでデータのインポートまたはエクスポートが行われていない場合は、ページ下部の**「データのエクスポート先...」** &gt; **「Azure Blob Storage」を**クリックしてください。
