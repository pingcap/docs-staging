...
> **注記：**
>
> この方法は、 TiDB Cloud StarterおよびTiDB Cloud Essentialインスタンスでのみ利用可能です。TiDB TiDB Cloud Dedicatedクラスターに接続する場合は、 [手動法](#connect-via-manually-setting-environment-variables)を使用してください。
