...
または、対象の TiDB Cloud Dedicated クラスターの **Alert** ページ右上にある **Subscribe** をクリックすることもできます。**Alert Subscription** ページに移動します。
...
> **Tip:**
>
> TiDB Cloud Essential では、アラートの購読は現在のインスタンス内のすべてのアラートに対して適用されます。複数の TiDB Cloud Essential インスタンスがある場合は、各インスタンスごとに個別に購読する必要があります。

1. [TiDB Cloud console](https://tidbcloud.com) で、組織の [**My TiDB**](https://tidbcloud.com/tidbs) ページに移動し、対象の TiDB Cloud Essential インスタンス名をクリックしてその概要ページに移動します。
...
または、対象の TiDB Cloud Essential インスタンスの **Alert** ページ右上にある **Subscribe** をクリックすることもできます。**Alert Subscription** ページに移動します。
...
> **Tip:**
>
> TiDB Cloud Premium では、アラートの購読は現在のインスタンス内のすべてのアラートに対して適用されます。複数の TiDB Cloud Premium インスタンスがある場合は、各インスタンスごとに個別に購読する必要があります。

1. [TiDB Cloud console](https://tidbcloud.com) で、組織の [**My TiDB**](https://tidbcloud.com/tidbs) ページに移動し、対象の TiDB Cloud Premium インスタンス名をクリックしてその概要ページに移動します。
2. 左側のナビゲーションペインで、**Settings** > **Alert Subscription** をクリックします。
3. **Alert Subscription** ページの右上にある **Add Subscriber** をクリックします。
4. **Subscriber Type** ドロップダウンリストから **Lark** を選択します。
5. **Name** フィールドに名前を入力し、**Webhook URL** フィールドに Lark webhook URL を、**Secret** フィールドに Lark secret を入力します。secret token は、Lark グループで "Sign Verification" を有効にした後にのみ生成される点に注意してください。
...
または、対象の TiDB Cloud Premium インスタンスの **Alert** ページ右上にある **Subscribe** をクリックすることもできます。**Alert Subscription** ページに移動します。
