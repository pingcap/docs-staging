...
このドキュメントでは、AWS Database Migration Service (AWS DMS) を使用して Amazon RDS for Oracle から[TiDB Cloudサーバーレス層](https://tidbcloud.com/console/clusters/create-cluster)にデータを移行する方法の例を段階的に説明します。
...
2.  ターゲットを設定します[TiDB Cloudサーバーレス層](https://tidbcloud.com/console/clusters/create-cluster) 。
...
## ステップ 4. TiDB Cloud Tier クラスターを作成する {#step-4-create-a-tidb-cloud-serverless-tier-cluster}

1.  [TiDB Cloudコンソール](https://tidbcloud.com/console/clusters)にログインします。プロジェクトの [**クラスター]**ページに移動します。

2.  無料の Serverless Tier クラスターを作成します。

    ![Create TiDB Cloud Serverless Tier](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-4.png)

3.  クラスターが作成されたら、[**セキュリティ設定]**をクリックしてユーザー パスワードを設定します。

    ![Set TiDB Cloud Serverless Tier Password](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-5.png)

    ![Set TiDB Cloud Serverless Tier Password](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-6.png)

4.  [**生成**] ボタンをクリックして、パスワードを生成します。生成されたパスワードを書き留めます。 [<strong>送信</strong>] ボタンをクリックします。

5.  [**接続**] ボタンをクリックして、TiDB クラスターを接続します。

    ![Connect to TiDB Cloud Serverless Tier](https://docs-download.pingcap.com/media/images/docs/tidb-cloud/aws-dms-from-oracle-to-tidb-7.png)
...
[サーバーレス階層クラスター](https://tidbcloud.com/console/clusters/create-cluster)に接続し、 `admin.github_event`のテーブルデータを確認します。次のスクリーンショットに示すように、DMS はテーブル`github_events`と 10000 行のデータを正常に移行しました。
