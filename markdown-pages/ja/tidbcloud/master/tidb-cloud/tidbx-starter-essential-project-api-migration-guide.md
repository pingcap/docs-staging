...
2026 年 4月 15日より、TiDB Cloud はリソースタイプごとに個別のプロジェクトタイプを導入します。TiDB Cloud Starter と Essential インスタンスについては、TiDB X プロジェクト内、または組織レベルで管理できるようになります。詳細は、[TiDB X Instances の Project Migration FAQ](/tidb-cloud/tidbx-instance-move-faq.md) を参照してください。
