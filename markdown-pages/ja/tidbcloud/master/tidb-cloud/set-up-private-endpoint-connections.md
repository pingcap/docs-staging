...
3.  プロジェクトの**「プロジェクト設定」**ページで、左側のナビゲーション ペインの**「ネットワーク アクセス」**をクリックし、「**プライベート エンドポイント**」&gt; **「AWS」**タブをクリックして AWS プライベート エンドポイントを表示します。
...
1.  **「AWS プライベートエンドポイント接続の作成」**ページで、 **「VPC ID」**フィールドと**「サブネット ID」**フィールドに入力します。ID は[AWS マネジメントコンソール](https://console.aws.amazon.com/)から取得できます。
