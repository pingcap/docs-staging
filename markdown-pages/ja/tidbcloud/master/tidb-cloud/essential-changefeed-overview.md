...
2026年7月1日より前に作成された既存の TiDB Cloud Essential インスタンスでは、変更フィードは無料です。

2026年7月1日以降、新しく作成された TiDB Cloud Essential インスタンスでは、変更フィードは課金対象機能です。請求の詳細については、[TiDB Cloud Essential Pricing Details](https://www.pingcap.com/tidb-cloud-essential-pricing-details/) を参照してください。
