...
4.  表示されたダイアログボックスには、以下の項目が表示されます。
    ...
    b. **API Key**: データ アプリの API キーを入力します。 API キーをまだ持っていない場合は、 **Create API Key**をクリックして作成します。詳細については、 [APIキーを作成する](/tidb-cloud/data-service-api-key.md#create-an-api-key)を参照してください。
